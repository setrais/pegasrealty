...
<body>
  <div id="wrap">
	...
	<div id="header" style="position:relative;">                
                <div id="icons">
                    <?/*<i style="padding-left:32px;font-size:12px;color: #15428b">Время работы: пн-пт с 10:00-20.00, сб., вс.-вых.</i>*/?>
                    <a href="/site/sitemap/" title="Карта сайта" >
                        <img width="16" height="16" border="0" alt="Карта сайта" src="/images/sitemap.png" />
                    </a>        
                </div>    
		<div id="logo" onclick="document.location.href='/';" style="cursor:pointer;">
                    <div style="line-height: 64px;text-align: right;font-size: 32px;padding-left: 64px;text-align: left;text-shadow: 1px 1px 2px #C9C8C6, 0 0 6px #DDDDDD;text-transform: uppercase;">
                        <a class="home" href="/" ><?php echo CHtml::encode(Yii::t("all","Pegas Realty")); ?></a>
                    </div>
                </div>
                ...
                <div id="email" style="position:absolute;line-height:27px;font-family:Calibri;right:24px;top:54px;vertical-align: middle;">                      
                    <i style="padding-left:32px;font-size:14px;color: /*#7f8a7f;*/#9e9f81;/*#4eba46/*#64B922*/"><?php echo Yii::app()->params["contact"]["email_main"];?></i>
	...
	<div id="footer">
            <div class="left"> 
		<div class="inline halign-l"><?=Yii::t('all','Copyright &copy;');?> 2012-2013<?php// echo date('Y'); ?> <?=Yii::t('all','All Rights Reserved.');?><br/><?=Yii::t('all','Real Estate Agency - "Pegas Realty"');?>
