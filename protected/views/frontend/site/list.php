...
$this->pageDescription=Yii::t('tcontent',$group->description);
$this->pageKeywords=explode(',',Yii::t('tcontent',$group->keywords));
                 ...
                 <div class="fl">
                     ...
                     <div class="info">
                         ...
                         <div class="anons">
                             ...
                             <?=CHtml::link( 'подробнее',str_replace('#id',$item->id.'.html',$item->url)); ?>
                         </div>
                     </div>                     
                 </div>
    <?                                                          
