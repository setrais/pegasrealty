	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <div class="tabs">
            ...
            <div class="row">
                    ...
                    <?php echo $form->dropDownList($model,'grid',                           
                           CHtml::listData( Iblocks::model()->findAll("(ACT IS NULL OR ACT=1) AND (DEL IS NULL OR DEL=0) AND ((TYPES_IBLOCKS_ID<>1)AND(GRID=0))",
        ...
        <div class="tabs" >
            <div class="row">
                    ...
                    <?php echo $form->textArea($model,'anons',array('style'=>'height: 74px;width: 400px;vertical-align:middle;margin:0;'/*,'maxlength'=>255*/)); ?>
