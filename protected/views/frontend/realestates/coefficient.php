...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    ...
                    ? ' | Аренда коммерческой недвижимости c коридорным коэффициентом '.$model->getCoefficient().' в Москве без комиссии.'
                     .' Снять нежилое помещение либо здание целиком c коридорным коэффициентом '.$model->getCoefficient().','
                     .' без посредников по стоимости аренды от собственника Москвы.'
                    : ' | Аренда коммерческой недвижимости по коридорным коэффициентам в Москве без комиссии.'
                     .' Снять нежилое помещение либо бизнес центр, банк, здание, особняк целиком различных'
                     .' коридорных коэффицентов, без посредников по стоимости аренды от собственника Москвы.');                

if ($model->coefficient_corridor) $this->pageDescription= 'Здесь отобраны предложения по аренде коммерческой недвижимости c коридорным коэффициентом '
                                          .$model->getCoefficient().' в Москве. '
                                         .'Предложения включают аренду офисных, банковских, торговых помещений в бизнес центре, парке,'
                                         .' жилом комплексе, доме, особняке, здании, медцентре, банке Москвы, а также аренду бизнес центров,'
                                         .' банков, особняков и зданий целиком c коридорным коэффициентом '.$model->getCoefficient()
                                         .'. Аренда коммерческой недвижимости c коридорным коэффициентом '.$model->getCoefficient()
                                         .' кроме этого отличается видом, классом, объектом размещения, адресом,'
                                         .' назначением, свойствами, удаленностью от метро, площадью, стоимостью, валютой.';                   
else $this->pageDescription= 'Здесь отобраны предложения аренды коммерческой недвижимости по коридорным коэффициентам в Москве.'
                                        .' Предложения включают аренду офисных, банковских, торговых помещений в бизнес центре, парке,'
                                        .' жилом комплексе, доме, особняке, здании, медцентре, банке Москвы, а также'
                                        .' аренду бизнес центров, банков, особняков и зданий целиком отличающихся между собой коридорными коэффициентами.'
                                        .' При этом аренда коммерческой недвижимости также отличается видом, объектом размещения, классом, адресом, назначением,'
                                        .' свойствами, удаленностью от метро, площадью, стоимостью, валютой расчетов.';

if ($model->coefficient_corridor) $this->pageKeywords= explode(',','аренда в москве коридорный коэффициент '.$model->getCoefficient() 
                                                                .', аренда коридорный коэффициент '.$model->getCoefficient() 
                                                                .', аренда москва коридорный коэффициент '.$model->getCoefficient() 
                                                                //.', аренда офисов москвы корридорный коеффициент '.$model->getCoefficient() 
                                                                .', коридорный коэффициент '.$model->getCoefficient() 
                                                                .', снять, каталог недвижимости, коммерческая недвижимоcть, недвижимость, аренда, коридорный коэффициент, москва, в москве, москвырайон, улица, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');                   
else $this->pageKeywords=explode(',', 'снять, аренда в москве, каталог недвижимости, коммерческая недвижимоcть, аренда, коридорный коэффициент, москва, москвы, в москве, район, улица, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');    
...
if ($model->coefficient_corridor) {
    $this->breadcrumbs=array(	
         ...
         'по коридорным коэффициентам'=>array('realestates/coefficient'),
	 'Аренда коммерческой недвижимости с коридорным коэффициентом '.$model->getCoefficient()." в Москве",
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
	 'Аренда коммерческой недвижимости в Москве по коридорным коэффициентам',
    );
}
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($model->coefficient_corridor 
                    ? 'Аренда коммерческой недвижимости c коридорным коэффициентом '.$model->getCoefficient().' в Москве без комиссии.'
                     .' Снять нежилое помещение в бизнес, торговом центре, особняке, банке, здании, жилом доме, комлексе, парке'
                     .' либо здание целиком c коридорным коэффициентом '.$model->getCoefficient().','
                     .' без посредников по стоимости аренды от собственника Москвы.'
                    : 'Аренда коммерческой недвижимости по коридорным коэффициентам в Москве без комиссии.'
                     .' Снять нежилое офисное, банковское, торговое помещение либо бизнес центр, банк, здание, особняк целиком различных'
                     .' корридорных коэффицентов, без посредников по стоимости аренды от собственника Москвы.');
?>
</h1>
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_coefficient.php';
?>
...
<?php 
    $model->search()->pagination->route = Yii::app()->createUrl('/realestates/coefficient'.($model->coefficient_corridor ? 'on' : 'off'));
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/coefficient') : Yii::app()->createUrl('/realestates/coefficient',array('id'=>$model->coefficient_corridor)),    
	...
	'columns'=>array(
		...
		'class'=>'CButtonColumn',                
           ...
           array( 'name'=>'coefficient_corridor',
                  'header'=> Yii::t('grid','Кор. коэф.'),  
                  'type'=> 'html',
                  'filter'=>CHtml::activeHiddenField($model,'coefficient_corridor'),                  
                  'value'=>'$data->getCoefficient();',  
                  'htmlOptions'=>array('style'=>'text-align:right;width:30px;'/*30px*/),
