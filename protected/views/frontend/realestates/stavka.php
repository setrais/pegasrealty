...
if (Yii::app()->getRequest()->getParam('price-from')&&Yii::app()->getRequest()->getParam('price-to')) {
    $offer = FstavkaOffers::model()->find('init_value='.Yii::app()->getRequest()->getParam('price-from').' AND final_value='.Yii::app()->getRequest()->getParam('price-to'));
} 
...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости с арендной ставкой от '.$offer->init_value.' до '
                     .$offer->final_value.' руб.'.' в Москве без комиссии.'
                     .' Снять нежилое помещение либо бизнес центр, банк, здание, особняк целиком по арендной ставке от '
                     .$offer->init_value.' до '.$offer->final_value.' руб./год,'
                     .' без посредников от собственника Москвы.'
                    : '  | Аренда коммерческой недвижимости по арендной ставке в Москве без комиссии. Снять нежилое (офисное, банковское, торговое) 
                                    помещение либо бизнес центр, банк, здание, особняк целиком различной арендной ставке, без посредников по стоимости аренды от собственника Москвы.');

if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения аренды коммерческой недвижимости с арендной ставкой от '
                                          .$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве. '
                                          .$offer->seo_desc 
                                        : 'Здесь отобраны предложения аренды коммерческой недвижимости с арендной ставкой от '
                                          .$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве.'
                                         .' Предложения включают аренду офисных, банковских, торговых помещений в бизнес центре,'
                                         .' парке, жилом комплексе, доме, особняке, здании, медцентре, банке Москвы, а также аренду'
                                         .' бизнес центров, банков, особняков и зданий целиком по арендной ставке от '
                                         .$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                         .' Аренда коммерческой недвижимости с арендной ставкой от '
                                         .$offer->init_value.' руб. до '.$offer->final_value.' руб.'
...
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости по арендной ставке нежилой недвижимости в Москве. Предложения включают аренду' 
                                        ...
                                        .' аренду бизнес центров, банков, особняков и зданий целиком отличающихся между собой арендной ставкой. Аренда коммерческой недвижимости'
                                        .' также отличается между собой видом, классом, объектом размещения, адресом, назначением, свойствами, удаленностью от метро,'
                                        .' стоимостью, валютой.');              
...
if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', 
                                                ...
                                                .', арендная ставка '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                //.', аренда от '.$offer->init_value.' рублей'
                                                //.', аренда до '.$offer->final_value.' рублей'
                                                .', арендная ставка '.$offer->init_value.'-'.$offer->final_value.' рублей' 
                                                .', аренда по арендной ставке '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                //.', аренда по ставке '.$offer->init_value.'-'.$offer->final_value.' рублей'
                                                //.', аренда по арендной ставке '.$offer->init_value.'-'.$offer->final_value.' рублей'                                        
                                        
                                                //.', аренда по ставке больше'.$offer->init_value.' руб.' 
                                                //.', аренда по ставке больше'.$offer->init_value.' рублей' 
                                                //.', арендная ставка больше'.$offer->init_value.' руб.' 
                                                //.', арендная ставка больше'.$offer->init_value.' рублей' 
                                        
                                                .', аренда в москве от '.$offer->init_value.' руб.'
                                                .', аренда в москве до '.$offer->final_value.' руб.'
                                                .', аренда в москве арендная ставка '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                .', аренда в москве от '.$offer->init_value.' рублей'
                                                .', аренда в москве до '.$offer->final_value.' рублей'
                                                .', аренда москва арендная ставка '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                .', аренда москва арендная ставка от '.$offer->init_value.' руб.'
                                                .', аренда москва арендная ставка до '.$offer->final_value.' руб.'
                                                //.', аренда в москве по арендной ставке '.$offer->init_value.'-'.$offer->final_value.' руб.' 
                                                //.', аренда в москве арендная ставка больше'.$offer->init_value.' руб.' 
                                                //.', аренда в москве арендная ставка больше'.$offer->init_value.' руб.' 
                                        
                                                .', снять, аренда по арендной ставке, арендная ставка от, арендная ставка до, от, до, руб., рублей, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц'),
...
else $this->pageKeywords=explode(',', ' снять, аренда в москве, каталог недвижимости, коммерческая недвижимоcть, аренда по арендной ставке, руб., рублей, м2, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');    
...
if ($offer) {
    $this->breadcrumbs=array(	
	 ...
	 $offer ? "Аренда коммерческой недвижимости с арендной ставкой от ".$offer->init_value.' руб. до '.$offer->final_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости по арендной ставке',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве без комиссии.'
                     .' Снять здание или нежилое помещение по арендной ставке от '.$offer->init_value.' до '.$offer->final_value.' руб./год'                       
                     .' без посредников согласно стоимости аренды от собственника Москвы.'
                    : 'Аренда коммерческой недвижимости по арендной ставке в Москве без комиссии. Снять нежилое помещение либо здание Москвы целиком 
                       с различной арендной ставкой, без посредников от собственника.');
?>        
</h1>
<?php if ($offer->anons) {  ?>    
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_stavka.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/stavka') : Yii::app()->createUrl('/realestates/stavka',array('id'=>$offer->id)),
