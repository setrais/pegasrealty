...
if (Yii::app()->getRequest()->getParam('price-from')&&Yii::app()->getRequest()->getParam('price-to')&&Yii::app()->getRequest()->getParam('valute')) {
    $offer = FcostOffers::model()->find('init_value='.Yii::app()->getRequest()->getParam('price-from').' AND final_value='.Yii::app()->getRequest()->getParam('price-to').' AND valute_id='.Yii::app()->getRequest()->getParam('valute'));
} 
...
$this->pageTitle=Yii::t('all','Коммерческая недвижимость')
                .($offer 
                  ? ($property->is_ceil 
                     ? ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' стоимостью аренды в месяц от '.$offer->init_value.' руб. до '
                             .$offer->final_value.' руб.'.' в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' по стоимости аренды от '.$offer->init_value.' до '
                             .$offer->final_value.' руб. целиком, без посредников от собственника Москвы.'
                     : ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' стоимостью аренды в месяц от '.$offer->init_value.' руб. до '
                             .$offer->final_value.' руб.'.' в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' по стоимости аренды '.$offer->init_value.' - '
                  ...
                  : ($property->is_ceil 
                     ? ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' в Москве по стоимости аренды в месяц без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' без посредников по стоимости аренды от собственника Москвы.' 
                     : ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' по стоимости аренды в Москве без комиссии.'
...
if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ...
                                        : 'Здесь отобраны предложения по аренде '.mb_strtolower($property->namewhats,'UTF-8').' со стоимостью аренды от '
                                          .$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве.';                   
else $this->pageDescription= 'Здесь отобраны предложения арендеы '.mb_strtolower($property->namewhats,'UTF-8').' Москвы, по стоимости аренды в месяц. ';
    ...
    if ($offer) {
        $this->pageDescription = ($property->is_ceil 
                                  ? 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' со стоимостью аренды в месяц от '
                                    .$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве. '
                                   .'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' стоимостью от '.$offer->init_value.' до '.$offer->final_value.' руб./мес.'
                                  ...
                                  : 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' со стоимостью аренды в месяц от '
                                   ...
                                   .' Аренда '.mb_strtolower($property->namewhats,'UTF-8').' стоимостью от '
                                    .$offer->init_value.' до '.$offer->final_value.' руб./мес.'.' отличается классом, объектом размещения, адресом, назначением, свойствами,'
                                    .' удаленностью от метро, валютой.');
    }else{
        $this->pageDescription = ($property->is_ceil 
                                  ? 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').'в Москве по стоимости аренды в месяц.'
                                   .' На стоимость аренды '.mb_strtolower($property->namewhats,'UTF-8').' влияет:'
                                   .' расположение, размещение, назначение, свойства, удаленность от метро, класс.'
                                  : 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' по стоимости аренды в месяц'
                                   .' в бизнес, мед.центре, парке, жилом комплексе, доме, особняке, здании, банке Москвы.'
                                   .' На стоимость аренды '.mb_strtolower($property->namewhats,'UTF-8').' влияет: расположение, размещение, назначение,'
...
if ($offer) $this->pageKeywords=trim($offer->seo_keywords)<>'' 
                                ? array_merge( explode(',', //'аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб.'
                                                         ...
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' стоимостью аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб.'
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' до '.$offer->final_value.' руб.'
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' стоимостью аренды '.$offer->init_value.'-'.$offer->final_value.' рублей' 
                                                         ...
                                                         ./*', аренда '.mb_strtolower($property->namewhats,'UTF-8').' в москве */', стоимость аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                         ...
                                                         ./*', аренда '.mb_strtolower($property->namewhats,'UTF-8').' в москве */', стоимость аренды '.$offer->init_value.'-'.$offer->final_value.' рублей' 
                                                         ...
                                                         ./*', аренда'.' '.mb_strtolower($property->namewhats,'UTF-8').*/', стоимость аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         //.', аренда'.' '.mb_strtolower($property->namewhats,'UTF-8').' в москве стоимостью аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         //.', аренда'.' '.mb_strtolower($property->namewhats,'UTF-8').' москвы со стоимостью аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' стоимость аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' в москве стоимость аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' москвы стоимостью аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'                                                                                                 
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' москва стоимость аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'                                                          
                                                         ...
                                                         .($property->title 
                                                                       ? //', аренда '.mb_strtolower($property->title,'UTF-8').' от '.$offer->init_value.' руб.'
                                                                        ...
                                                                        //.', аренда '.mb_strtolower($property->title,'UTF-8').' стоимостью аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        /*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', с стоимостью аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        ./*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', с стоимостью аренды '.$offer->init_value.'-'.$offer->final_value.' рублей'
                                                          ...
                                                          .($property->abbr 
                                                                        ...
                                                                        //.', аренда '.mb_strtolower($property->abbr,'UTF-8').' стоимостью аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        //.', аренда '.mb_strtolower($property->abbr,'UTF-8').' стоимость аренды '.$offer->init_value.'-'.$offer->final_value.' рублей'
                                                                        ...
                                                                        /*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', стоимость аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        ./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', стоимость аренды в месяц '.$offer->init_value.'-'.$offer->final_value.' рублей'
                                                            ...
                                                            .', снять, стоимость аренды, от, между, стоимость аренды в месяц, стоимости аренды, с стоимостью аренды, аренды, больше, до, руб., рублей, каталог, недвижимость, аренда, москва, в москве, москвы, класса, коммерческой недвижимости, округ, район, метро, удаленность, вид, свойства, площадь, м2, планировка, парковка, стоимость'),
                                ...
                                : explode(',', //'аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб.'
                                                         ...
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' стоимость аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' в москве стоимость аренды от '.$offer->init_value.' м2 до '.$offer->final_value.' руб.'
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' москвы стоимостью аренды от '.$offer->init_value.' м2 до '.$offer->final_value.' руб.'                                                                                                 
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' москва стоимость аренды от '.$offer->init_value.' м2 до '.$offer->final_value.' руб.'                                                          
...
if ($offer&&$property->namewhats) {
        ...
        $this->breadcrumbs=array(	
             ...
             'по стоимости '=>array('realestates/cost'),
             'стоимость '.$offer->init_value.' - '.$offer->final_value.' руб./мес.'=>Yii::app()->createUrl('realestates/cost',array('id'=>$offer->id)),
             'по видам'=>array('realestates/vid'),
              mb_strtolower($property->nameov,'UTF-8')=>Yii::app()->createUrl('realestates/vid',array('id'=>$property->id)),
             'Аренда '.mb_strtolower($property->namewhats,'UTF-8')." стоимостью от ".$offer->init_value.' до '.$offer->final_value.' руб./мес. в Москве' 
        );
        ...
        $this->breadcrumbs=array(	
             ...
             'по стоимости'=>array('realestates/cost'),
             'по видам'=>array('realestates/vid'),
             'Аренда коммерческой недвижимости в Москве по стоимости аренды в месяц'
        );
}
...
<h1>
    <?php  echo //Yii::t('all','Коммерческая недвижимость')
                ($offer
                  ? ($property->is_ceil 
                     ? 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' целиком со стоимостью аренды в месяц от '.$offer->init_value.' до '.$offer->final_value.' руб.'.' без комиссии в Москве.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' по стоимости аренды от '.$offer->init_value.' до '.$offer->final_value.' руб./мес.'
                      .' без посредников от собственника Москвы.'
                     : 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' со стоимостью аренды в месяц от '.$offer->init_value.' до '.$offer->final_value.' руб.'.' без комиссии в Москве.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' по стоимости аренды '.$offer->init_value.' - '.$offer->final_value.' руб./мес.'.' в бизнес центре, парке, особняке, банке, здании, жилом доме,'
                      .' комлексе без посредников от собственника Москвы.')
                  : ($property->is_ceil 
                     ? 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' в Москве целиком по стоимости аренды в месяц без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' без посредников по стоимости аренды от собственника Москвы.' 
                     : 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' в Москве по стоимости без комиссии.'
...
<? } ?>        
<?php 
    //$model->search()->pagination->route = Yii::app()->createUrl('/realestates/cost', array('id'=>$offer->id)); 
    $model->search()->pagination->route = Yii::app()->createUrl('/ru/realestates/cost/'.$offer->id.'/vid/'.$property->id); 
...
<?php $this->widget('application.components.widgets.DSizerListView', array(
	...
	'itemView'=>'_view_column',
        ...
        //'ajaxUrl'=>Yii::app()->createUrl('/ru/realestates/cost/'.$offer->id.'/vid/'.$property->id),
