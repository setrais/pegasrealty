...
if (Yii::app()->getRequest()->getParam('price-from')&&Yii::app()->getRequest()->getParam('price-to')) {
    $offer = FcostOffers::model()->find('init_value='.Yii::app()->getRequest()->getParam('price-from').' AND final_value='.Yii::app()->getRequest()->getParam('price-to'));
} 
...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости cо стоимостью аренды в месяц от '.$offer->init_value.' руб. до '
                     .$offer->final_value.' руб. в Москве без комиссии.'
                     .' Снять нежилое помещение или здание целиком по стоимости аренды от '
                     .$offer->init_value.' руб. до '.$offer->final_value.' руб.,'
                     .' без посредников от собственника Москвы.'
                    : '  | Аренда коммерческой недвижимости в Москве по стоимости аренды в месяц без комиссии. Снять нежилое (офисное, банковское, торговое)'
                     .' помещение либо здание целиком, без посредников по стоимости аренды от собственника Москвы.');
              

if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения аренды коммерческой недвижимости со стоимость аренды в месяц от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве. '
                                          .$offer->seo_desc
                                        : 'Здесь отобраны предложения аренды коммерческой недвижимости со стоимостью аренды в месяц от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве.'
                                         .' Предложения включают аренду нежелых помещений в бизнес центрах, парках, жилых комплексах, домах, особняках, зданиях,'
                                         .' медцентрах, банках Москвы, а также аренду бизнес центров, банков, особняков и зданий целиком с стоимостью аренды от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                         .' При этом аренда нежилой недвижимости согласно стоимости аренды в месяц также отличается классом, видом, объектом размещения,'
                                         .' адресом, назначением, свойствами, удаленностью от метро, классом, валютой.';                   
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости по стоимости аренды в Москве. Предложения включают аренду' 
                                        .' нежелых помещений в бизнес центрах, парках, жилых комплексах, домах, особняках, зданиях, медцентрах, банках Москвы,'
                                        .' а также аренду бизнес центров, банков, особняков и зданий целиком отличающихся между собой стоимость аренды в месяц.'
                                        .' При этом аренда коммерческой недвижимости отличается между собой видом, объектом размещения, классом, адресом, назначением,'
                                        .' свойствами, удаленностью от метро, стоимостью, валютой.');

if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', 
                                                  ' аренда от '.$offer->init_value.' руб.'
                                                .', аренда до '.$offer->final_value.' руб.'
                                                .', стоимость аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                //.', аренда от '.$offer->init_value.' рублей'
                                                //.', аренда до '.$offer->final_value.' рублей'
                                                .', стоимость аренды '.$offer->init_value.'-'.$offer->final_value.' рублей' 
                                                .', аренда стоимостью '.$offer->init_value.'-'.$offer->final_value.' руб. в месяц'
                                                //.', аренда стоимостью '.$offer->init_value.'-'.$offer->final_value.' рублей'
                                                //.', аренда стоимостью '.$offer->init_value.'-'.$offer->final_value.' рублей'                                        
                                        
                                                //.', аренда стоимостью больше'.$offer->init_value.' руб.' 
                                                //.', аренда стоимостью больше'.$offer->init_value.' рублей' 
                                        
                                                .', аренда в москве от '.$offer->init_value.' руб.'
                                                .', аренда в москве до '.$offer->final_value.' руб.'
                                                .', аренда в москве стоимостью '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                .', аренда в москве от '.$offer->init_value.' рублей'
                                                .', аренда в москве до '.$offer->final_value.' рублей'
                                                .', аренда москва стоимостью '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                .', аренда москва стоимостью '.$offer->init_value.' руб.'
                                                .', аренда москва стоимость от '.$offer->final_value.' руб.'
                                                .', аренда москва стоимость до '.$offer->final_value.' руб.'
                                                //.', аренда в москве стоимостью в месяц '.$offer->init_value.'-'.$offer->final_value.' руб.' 
                                                //.', аренда в москве стоимостью больше'.$offer->init_value.' руб.' 
                                                //.', аренда в москве стоимостью больше'.$offer->init_value.' руб.' 
                                        
                                                .', снять, стоимость аренды в месяц, стоимость аренды, стоимость аренды от, стоимость аренды до, от, до, руб., рублей, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц'),
                                ...
                                : explode(',', ' аренда от '.$offer->init_value.' руб.'
                                                .', аренда до '.$offer->final_value.' руб.'
                                                .', стоимость аренды '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                //.', аренда от '.$offer->init_value.' рублей'
                                                //.', аренда до '.$offer->final_value.' рублей'
...
else $this->pageKeywords=explode(',', 'снять, аренда в москве, каталог недвижимости, коммерческая недвижимоcть, стоимость аренды, стоимость аренды в месяц, стоимость аренды от, стоимость аренды до, от, до, руб., рублей, м2, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');    
...
if ($offer) {
    $this->breadcrumbs=array(	
	 ...
	 $offer ? "Аренда коммерческой недвижимости с стоимостью аренды в месяц от ".$offer->init_value.' до '.$offer->final_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости по стоимости аренды в месяц',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
	 $offer ? "Аренда коммерческой недвижимости стоимостью аренды в месяц от ".$offer->init_value.' до '.$offer->final_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости по стоимости аренды в месяц',
    );
}
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости в Москве со стоимостью аренды в месяц от '.$offer->init_value.' до '.$offer->final_value.' руб.'.' без комиссии.'
                     .' Снять здание или нежилое помещение Москвы без посредников по стоимости аренды от собственника.'
                    : 'Аренда коммерческой недвижимости по стоимости аренды в месяц в Москве без комиссии. Снять нежилое помещение либо здание Москвы целиком 
                       различной стоимостью аренды за месяц, без посредников от собственника.');
?>       
</h1>
<?php if ($offer->anons) {  ?>    
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_cost.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/cost') : Yii::app()->createUrl('/realestates/cost',array('id'=>$offer->id)),
