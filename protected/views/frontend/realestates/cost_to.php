...
if (Yii::app()->getRequest()->getParam('price-to')) {
    $offer = FcostOffers::model()->find('final_value='.Yii::app()->getRequest()->getParam('price-to'));
} 
...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости cо стоимостью аренды в месяц до '
                     .$offer->final_value.' руб. в Москве без комиссии.'
                     .' Снять нежилое помещение или здание целиком по стоимости аренды до '.$offer->final_value.' руб.,'
                     .' без посредников от собственника Москвы.'
                    : '  | Аренда коммерческой недвижимости в Москве до стоимости аренды в месяц без комиссии. Снять нежилое (офисное, банковское, торговое)'
                     .' помещение либо здание целиком, без посредников до различной стоимости аренды от собственника Москвы.');

if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения аренды коммерческой недвижимости со стоимость аренды в месяц до '.$offer->final_value.' руб.'.' в Москве. '
                                          .$offer->seo_desc
                                        : 'Здесь отобраны предложения аренды коммерческой недвижимости со стоимостью аренды в месяц до '.$offer->final_value.' руб.'.' в Москве.'
                                         .' Предложения включают аренду нежелых помещений в бизнес центрах, парках, жилых комплексах, домах, особняках, зданиях,'
                                         .' медцентрах, банках Москвы, и кроме того аренду бизнес центров, банков, особняков и зданий целиком с стоимостью аренды до '.$offer->final_value.' руб.'
                                         .' Также аренда нежилой недвижимости согласно стоимости аренды в месяц также отличается классом, видом, объектом размещения,'
                                         .' адресом, назначением, свойствами, удаленностью от метро, классом, валютой.';                   
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости до различной стоимости аренды в Москве. Предложения включают аренду' 
                                        .' нежелых помещений в бизнес центрах, парках, жилых комплексах, домах, особняках, зданиях, медцентрах, банках Москвы,'
                                        .' а кроме того аренду бизнес центров, банков, особняков и зданий целиком имеющих различную стоимость аренды в месяц.'
                                        .' Также аренда коммерческой недвижимости отличается между собой видом, объектом размещения, классом, адресом, назначением,'
                                        .' свойствами, удаленностью от метро, валютой.');

if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', 
                                                  ' аренда до '.$offer->final_value.' руб.'
                                                .', аренда до '.$offer->final_value.' рублей'
                                                .', аренда стоимостью меньше '.$offer->final_value.' руб.' 
                                                .', аренда стоимостью меньше '.$offer->final_value.' рублей' 
                                                .'. стоимость аренды до '.$offer->final_value.' рублей' 
                                                .', аренда в москве до '.$offer->final_value.' руб.'
                                                .', аренда в москве до '.$offer->final_value.' рублей'
                                                //.', аренда москва стоимостью '.$offer->final_value.' руб.'
                                                .', аренда москва стоимость до '.$offer->final_value.' руб.'
                                                .', аренда в москве стоимостью меньше '.$offer->init_value.' руб.' 
                                                .', аренда в москве стоимостью меньше '.$offer->init_value.' руб.' 
                                        
                                                .', снять, стоимость аренды в месяц, стоимость аренды, стоимость аренды до, до, руб., рублей, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц'),
                                ...
                                : explode(',', ' аренда до '.$offer->final_value.' руб.'
                                                .', аренда до '.$offer->final_value.' рублей'
                                                .', аренда стоимостью меньше '.$offer->final_value.' руб.' 
                                                .', аренда стоимостью меньше '.$offer->final_value.' рублей' 
                                                .'. стоимость аренды до '.$offer->final_value.' рублей' 
...
if ($offer) {
    $this->breadcrumbs=array(	
	 ...
	 $offer ? "Аренда коммерческой недвижимости с стоимостью аренды в месяц до ".$offer->final_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости до различной стоимости аренды в месяц',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости в Москве со стоимостью аренды в месяц до '.$offer->final_value.' руб.'.' без комиссии.'
                    ...
                    : 'Аренда коммерческой недвижимости по стоимости аренды в месяц в Москве без комиссии. Снять нежилое помещение либо здание Москвы целиком 
                       согласно стоимости аренды, без посредников от собственника.');
?>          
</h1>
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_cost_to.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/costTo') : Yii::app()->createUrl('/realestates/costTo',array('id'=>$offer->id)),
