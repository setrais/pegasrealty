...
if (isset($model->is_separate_entrance) && $model->is_separate_entrance ) 
    $this->pageTitle.= ' | Аренда коммерческой недвижимости c отдельным входом в Москве.'
                      .' Снять нежилое помещение имеющее отдельный вход в особняке, бизнес центре, банке, жилом доме, комлексе, парке'
                      .' либо здание Москвы без посредников от собственника.';
else if (isset($model->is_separate_entrance) && !$model->is_separate_entrance) 
    $this->pageTitle.= ' | Аренда коммерческой недвижимости без отдельного входа в Москве.' 
                      .' Снять нежилое помещение не имеющее отдельный входом в особняке, бизнес центре, банке, жилом доме, комлексе, парке'
                      .' либо здание Москвы без посредников от собственника.';
else 
    $this->pageTitle.= ' | Аренда коммерческой недвижимости по наличию отдельного входа в Москве.'
                      .' Снять нежилое офисное, банковское, торговое'
                      .' помещение либо бизнес центр, банк, здание, особняк целиком с различным наличием отдельного входа,'
                      .' без посредников от собственника Москвы.';

if (isset($model->is_separate_entrance) && $model->is_separate_entrance ) 
     $this->pageDescription='Здесь отобраны предложения по аренде коммерческой недвижимости Москвы c отдельным входом '
                           .' Предложения состоят из аренды торговых, банковских, офисных, помещений в бизнес центре, парке, жилом комплексе, доме, особняке, здании,'
                           .' медцентре, банке Москвы, а также включают аренду бизнес центров, банков, особняков и зданий целиком при наличии отдельного входа.'
                           .' Аренда коммерческой недвижимости с отдельным входом, отличается по '
                           .' виду недвижимости, объекту размещения, классу, назначению, другим свойствам, удаленности от метро, площади, стоимости.';                   
else if (isset($model->is_separate_entrance) && !$model->is_separate_entrance) 
     $this->pageDescription='Здесь отобраны предложения по аренде коммерческой недвижимости Москвы без отдельного входа'     
                           .' Предложения состоят из аренды торговых, банковских, офисных, помещений в бизнес центре, парке, жилом комплексе, доме, особняке, здании,'
                           .' медцентре, банке в Москве, а также включают аренду бизнес центров, банков, особняков и зданий целиком за неимением отдельного входа.'
                           .' Аренда коммерческой недвижимости без отдельного входа, отличается по '
                           .' виду недвижимости, объекту размещения, классу, назначению, другим свойствам, удаленности от метро, площади, стоимости.';                   
else $this->pageDescription='Здесь отобраны предложения аренды коммерческой недвижимости Москвы по наличию отдельного входа. Предложения включают аренду' 
                           ...
                           .' аренду бизнес центров, банков, особняков и зданий целиком отличающихся между собой наличием отдельного входа и имеющих при этом '
                           .' различный вид, размещение, адресс, назначение, класс, свойства, удаленность от метро, площадь, стоимость.';

if ($model->is_separate_entrance) $this->pageKeywords=explode(',', 
                                                        'аренда с отдельным входом'
                                                        .', аренда с отдельным входом в москве'
                                                        .', снять, с отдельным входом, каталог недвижимости, коммерческая недвижимость, аренда, вход, москва, москве, москвы,  район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');                   
else if (isset($model->is_separate_entrance) && !$model->is_separate_entrance) $this->pageKeywords=explode(',', 
                                                        'аренда без отдельного входа'
                                                        .', аренда без отдельного входа в москве'
                                                        .', снять, без отдельного вход, каталог недвижимости, коммерческая недвижимость, аренда, вход, москва, москве, москвы,  район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');                   
else $this->pageKeywords=explode(',', 'снять, аренда в москве, каталог недвижимости, коммерческая недвижимоcть, аренда, отдельный вход, вход, москва, москве, москвы,  район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');    

if (isset($model->is_separate_entrance)) {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
         'по наличию отдельного входа'=>array('realestates/entrance'),
         'Аренда коммерческой недвижимости Москвы, '.($model->is_separate_entrance ? 'с отдельным входом' : 'без отдельного входа')
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
	 'Аренда коммерческой недвижимости Москвы, по отдельному входу'
    );
}
?>
...
<?php    
if (isset($model->is_separate_entrance) && $model->is_separate_entrance ) 
    echo 'Аренда коммерческой недвижимости c отдельным входом в Москве.'
        .' Снять нежилое помещение имеющее отдельный вход в особняке, бизнес центре, банке, жилом доме, комлексе, парке'
        .' либо здание Москвы без посредников от собственника.';
else if (isset($model->is_separate_entrance) && !$model->is_separate_entrance) 
    echo 'Аренда коммерческой недвижимости без отдельного входа в Москве.' 
        .' Снять нежилое помещение не имеющее отдельный входом в особняке, бизнес центре, банке, жилом доме, комлексе, парке'
        .' либо здание Москвы без посредников от собственника.';
else 
    echo 'Аренда коммерческой недвижимости по наличию отдельного входа в Москве.'
        .' Снять нежилое офисное, банковское, торговое'
        .' помещение либо бизнес центр, банк, здание, особняк целиком с различным наличием отдельного входа,'
        .' без посредников от собственника Москвы.';  
?>
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_entrance.php';
?>
...
<?php 
    $model->search()->pagination->route = Yii::app()->createUrl('/realestates/entrance'.($model->is_separate_entrance ? 'on' : 'off'));
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        //'ajaxUrl'=>Yii::app()->createUrl('/realestates/entrance'.($model->is_separate_entrance ? 'on' : 'off')),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/entrance') : Yii::app()->createUrl('/realestates/entrance'.($model->is_separate_entrance ? 'on' : 'off')),
	...
	'columns'=>array(
		...
		'class'=>'CButtonColumn',                
           ...
           array( 'name'=>'is_separate_entrance',
                  'header'=>Yii::t('all','ОтВход'),
                  'type'=> 'html',
                  'filter'=>CHtml::activeHiddenField($model,'is_separate_entrance'),                  
                  'value'=>'($data->is_separate_entrance  ? "с отдельным входом" : "без отдельного входа ")',  
                  'htmlOptions'=>array('style'=>'text-align:center;width:10px;font-size:0.7%;'),
           ...
           array( 'name'=>'is_separate_entrance',
                  ...
                  'header'=>Yii::t('all','ОтВход'),
                  'type'=>'text',
                  'filter'=>CHtml::activeDropDownList($model,'is_separate_entrance',array(""=>"","1"=>"c","0"=>"без")),
                  'value'=>'($data->is_separate_entrance  ? "с отдельным входом" : "без отдельного входа ")',                     
                  'htmlOptions'=>array('style'=>'width:10px;text-align:center;font-size:0.7%'),
                  'headerHtmlOptions'=>array('width'=>'10'),
                   'visible'=>$property->is_all,
                ),                          
