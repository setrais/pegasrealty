...
$extraRowExpression = '"<div style=\"float:left; padding-right: 10px;\">".CHtml::link(CHtml::image( 
                                 ...
                                 <div style=\"font-size: 0.95em;font-famely:Thahome;padding:0 5px;margin:0px 0;display:block;\">
                                         <div>
                                            <p class=\"anons m-0 p-b1 fs-11\">"."Коммерческая недвижимость: ".CHtml::encode( str_replace(",","",HRu::cutstr($data->anons,'.($short ? 450/*450*/ : 750).')))."</p>
                                            <p class=\"m-0 m-b4 m-t6 fs-'.($short ? 11 : 10).'\">".
                                                  ...
                                                  ." ".CHtml::link("Подробнее об аренде коммерческой недвижимости...",Yii::app()->controller->createUrl("/realestates/".$data->primaryKey), array("title"=>"Недвижимость/Аренда/Офиса в Москве - ".$data->title, "class"=>"fs-11" ))."                                                     
                                            </p>        
                                        </div>"./*$data->anons.*/" 
                                 </div>"';
