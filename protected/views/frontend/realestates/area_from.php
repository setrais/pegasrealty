...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости площадью от '.$offer->init_value.' м2 '
                     .' в Москве без комиссии.'
                     .' Снять нежилое недвижимость площадью от '
                     .$offer->init_value.' м2,'
                     .' без посредников по стоимости аренды от собственника в административных округах г.Москвы'
                    : '  | Аренда коммерческой недвижимости по площади в Москве без комиссии. Снять нежилую недвижимость различной площади'
                     .' без посредников по стоимости аренды от собственника в административных округах г.Москвы');

if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения аренды коммерческой недвижимости площадью от '.$offer->init_value.' м2'.' в Москве. '
                                          .$offer->seo_desc 
                                        : 'Здесь отобраны предложения аренды коммерческой недвижимости площадью от '.$offer->init_value.' м2'.' в Москве. '
                                         .'Предложения включают аренду нежилой недвижимости в административных округах г.Москвы площадью от '.$offer->init_value.' м2'
                                         .'. Аренда коммерческой недвижимости площадью от '.$offer->init_value.' м2'
                                         .' также отличается видом, объектом размещения, адресом, назначением, свойствами, удаленностью от метро, классом, стоимостью, валютой.';                   
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости по площади в административных округах Москвы.'
                                        .' Предложения включают аренду нежилой недвижимости в административных округах г.Москвы'
                                        .' отличающихся между собой сдаваемой площадью. Аренда коммерческой недвижимости также отличается между собой'
                                        .' видом, объектом размещения, классом, адресом, назначением, свойствами, удаленностью от метро, стоимостью, валютой.');                                
...
if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', 
                                                ...
                                                .', аренда площади, площадь, площадь от, от, кв.м, квадратный метр, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц, нежилая, коммерческая, округ'),
...
if ($offer) {
    $this->breadcrumbs=array(	
	 ...
	 $offer ? "Аренда коммерческой недвижимости площадью от ".$offer->init_value." м2 по округам в Москве" 
                : 'Аренда коммерческой недвижимости по площади в адмистративных округах Москвы',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
	 $offer ? "Аренда коммерческой недвижимости площадью от ".$offer->init_value." м2 по округам в Москве" 
                : 'Аренда коммерческой недвижимости по площади в адмстративных округах Москвы',
    );
}
?>
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости площадью от '.$offer->init_value.' м2'.' в Москве без комиссии.'
                     .' Снять нежилую недвижимость площадью от '.$offer->init_value.' м2'                       
                     .' без посредников по стоимости аренды от собственника в адм.округах г.Москвы.'
                    : 'Аренда коммерческой недвижимости по площади в Москве без комиссии.'
                     .' Снять нежилую недвижимость различной площади без посредников' 
                     .' по стоимости аренды от собственника в административных округах г.Москвы');
?>      
</h1>
<?php if ($offer->anons) {  ?>    
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_area_from.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/areaFrom') : Yii::app()->createUrl('/realestates/areaFrom',array('id'=>$offer->id)),  
