...
if (Yii::app()->getRequest()->getParam('price-from')) {
    $offer = FcostOffers::model()->find('init_value='.Yii::app()->getRequest()->getParam('price-from'));
} 
...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости cо стоимостью аренды в месяц от '.$offer->init_value.' руб.'
                     .' в Москве без комиссии.'
                    ...
                    : '  | Аренда коммерческой недвижимости в Москве от стоимости аренды в месяц без комиссии. Снять нежилое (офисное, банковское, торговое)'
                     .' помещение либо здание целиком, без посредников от стоимости аренды собственника Москвы.');
                    //.' - '.str_replace('офисов','офиса', Yii::t('all',Yii::app()->name));str_replace('офисов','офиса', Yii::t('all',Yii::app()->name));

if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения аренды коммерческой недвижимости со стоимость аренды в месяц от '.$offer->init_value.' руб.'.' в Москве. '
                                          .$offer->seo_desc
                                        : 'Здесь отобраны предложения аренды коммерческой недвижимости со стоимостью аренды в месяц от '.$offer->init_value.' руб.'.' в Москве.'
                                         .' Предложения включают аренду нежелых помещений в бизнес центрах, парках, жилых комплексах, домах, особняках, зданиях,'
                                         .' медцентрах, банках Москвы, а также аренду бизнес центров, банков, особняков и зданий целиком с стоимостью аренды от '.$offer->init_value.' руб.'
...
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости от стоимости аренды в Москве. Предложения включают аренду' 
                                        .' нежелых помещений в бизнес центрах, парках, жилых комплексах, домах, особняках, зданиях, медцентрах, банках Москвы,'
                                        .' а также аренду бизнес центров, банков, особняков и зданий целиком отличающихся между собой стоимостью аренды в месяц.'
                                        .' Кроме этого аренда коммерческой недвижимости отличается между собой видом, объектом размещения, классом, адресом, назначением,'
...
if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', 
                                                ...
                                                .', аренда в москве стоимостью больше '.$offer->init_value.' рублей' 
                                        
                                                .', снять, стоимость аренды в месяц, стоимость аренды, аренда стоимостью, стоимостью больше, стоимость аренды от, от, руб., рублей, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц'),
...
else $this->pageKeywords=explode(',', 'снять, аренда в москве, каталог недвижимости, коммерческая недвижимоcть, стоимость аренды, стоимость аренды в месяц, стоимость аренды от, от, руб., рублей, м2, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц');    
...
if ($offer) {
    $this->breadcrumbs=array(	
	 ...
	 $offer ? "Аренда коммерческой недвижимости со стоимостью аренды в месяц от ".$offer->init_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости от стоимости аренды в месяц',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
	 $offer ? "Аренда коммерческой недвижимости стоимостью аренды в месяц от ".$offer->init_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости от стоимости аренды в месяц',
    );
}
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости в Москве со стоимостью аренды в месяц от '.$offer->init_value.' руб.'.' без комиссии.'
                     .' Снять здание или нежилое помещение Москвы без посредников по стоимости аренды от собственника.'
                    : 'Аренда коммерческой недвижимости от стоимости аренды в месяц в Москве без комиссии. Снять нежилое помещение либо здание Москвы целиком 
                       со стоимостью аренды за месяц, без посредников от собственника.');
?>      
</h1>
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_cost_from.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/costFrom') : Yii::app()->createUrl('/realestates/costFrom',array('id'=>$offer->id)),
