...
if (Yii::app()->getRequest()->getParam('price-from')&&Yii::app()->getRequest()->getParam('valute')) {
    $offer = FstavkaOffers::model()->find('init_value='.Yii::app()->getRequest()->getParam('price-from').' AND valute_id='.Yii::app()->getRequest()->getParam('valute'));
} 
...
$this->pageTitle=Yii::t('all','Коммерческая недвижимость')
                .($offer 
                  ? ($property->is_ceil 
                     ? ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '.$offer->init_value.' руб. '.'в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой от '.$offer->init_value.' руб./год целиком,'
                      .' без посредников по стоимости аренды от собственника Москвы.'
                     : ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '.$offer->init_value.' руб. '.'в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой от '
                      .$offer->init_value.' руб./год в торговом, бизнес центре, парке, особняке, банке, здании, жилом доме,'
                      .' комлексе без посредников от собственника Москвы.')
                  : ($property->is_ceil 
                     ? ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' от арендной ставки в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' согласно арендной ставке в год, без посредников по стоимости аренды от собственника Москвы.' 
                     : ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' от арендной ставки в Москве без комиссии.'
                      ...
                      .' торговом центре согласно арендной ставке в год, без посредников по стоимости аренды от собственника Москвы.'));
...
if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ...
                                        : 'Здесь отобраны предложения по аренде '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '
                                          .$offer->init_value.' руб.'.' в Москве.';                   
else $this->pageDescription= 'Здесь отобраны предложения по аренде '.mb_strtolower($property->namewhats,'UTF-8').' согласно арендной ставке в Москве. ';
    ...
    if ($offer) {
        $this->pageDescription = ($property->is_ceil 
                                  ? 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '
                                    .$offer->init_value.' руб.'.' в Москве. '
                                   .'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' целиком с арендной ставкой от '.$offer->init_value.' руб./год'
                                  ...
                                  : 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '
                                   ...
                                   .' Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой от '
                                    .$offer->init_value.' руб./год'.' отличается объектом размещения, адресом, назначением, свойствами,'
                                    .' удаленностью от метро, классом, стоимостью, валютой.');
    }else{
        $this->pageDescription = ($property->is_ceil 
                                  ? 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' от арендной ставки '
                                   .' в Москве. Аренда '.mb_strtolower($property->namewhats,'UTF-8').' целиком согласно арендной ставке в год '
                                   .' также отличается адресом, назначением, свойствами, удаленностью от метро, классом, стоимостью, валютой.'
                                  : 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' от арендной ставки '
                                   .' в бизнес центре, парке, жилом комплексе, доме, особняке, здании, медцентре, банке Москвы.'
                                   .' Аренда '.mb_strtolower($property->namewhats,'UTF-8').' согласно арендной ставке в год отличается объектом размещения, адресом, назначением,'
...
if ($offer) $this->pageKeywords=trim($offer->seo_keywords)<>'' 
                                ? array_merge( explode(',', //'аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб.'                                                                                                                  
                                                         ...
                                                         ./*', аренда '.mb_strtolower($property->namewhats,'UTF-8').' в москве */', арендная ставка больше '.$offer->init_value.' руб.' 
                                                         ...
                                                         .($property->title 
                                                                       ? //', аренда '.mb_strtolower($property->title,'UTF-8').' от '.$offer->init_value.' руб.'
                                                                        ...
                                                                        ./*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', с арендной ставкой больше '.$offer->init_value.' руб.'
                                                          ...
                                                          .($property->abbr 
                                                            ...
                                                            .', снять, арендная ставка, от, ставка, больше, руб., рублей, каталог, недвижимость, аренда, москва, в москве, москвы, класса, коммерческой недвижимости, округ, район, метро, удаленность, вид, свойства, площадь, м2, планировка, парковка, стоимость'),
                                ...
                                : explode(',', //'аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб.'                                                                                                                  
                                                         ...
                                                         .($property->title 
                                                          ...
                                                          .($property->abbr 
                                                                        ...
                                                                        .', '.mb_strtolower($property->abbr,'UTF-8') : '')  
                                                            .', снять, арендная ставка, от, ставка, больше, руб., рублей, каталог, недвижимость, аренда, москва, в москве, москвы, класса, коммерческой недвижимости, округ, район, метро, удаленность, вид, свойства, площадь, м2, планировка, парковка, стоимость');                   
else $this->pageKeywords=explode(',', 'снять, аренда в москве, аренда москвы, аренда по ставке, ставка, от, ставке, больше, руб., рублей, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, класса, коммерческой недвижимости, округ, район, улица, метро, удаленность, вид, свойства, площадь, планировка, парковка, стоимость в месяц, налогооблажение');    
...
if ($offer&&$property->namewhats) {
        ...
        $this->breadcrumbs=array(	
             ...
             'от арендной ставки'=>array('realestates/stavkaFrom'),
             'арендная ставка от '.$offer->init_value.' руб./год'=>Yii::app()->createUrl('realestates/stavkaFrom',array('id'=>$offer->id)),
             'по видам'=>array('realestates/vid'),
              mb_strtolower($property->nameov,'UTF-8')=>Yii::app()->createUrl('realestates/vid',array('id'=>$property->id)),
             'Аренда '.mb_strtolower($property->namewhats,'UTF-8')." с арендной ставкой от ".$offer->init_value.' руб./год'.' в Москве' 
        );
        ...
        $this->breadcrumbs=array(	
             ...
             'по видам'=>array('realestates/vid'),
              mb_strtolower($property->nameov,'UTF-8')=>Yii::app()->createUrl('realestates/vid',array('id'=>$property->id)),
             'Аренда '.mb_strtolower($property->namewhats,'UTF-8')." c арендной ставкой от ".$offer->init_value.' руб./год'.' в Москве'
        );
} else if ($offer && !$property->namewhats) {
        ...
        $this->breadcrumbs=array(	
             ...
             'арендная ставка от '.$offer->init_value.' руб./год'=>Yii::app()->createUrl('realestates/stavkaFrom',array('id'=>$offer->id)),
             'по видам'=>array('realestates/vid'),
             'Аренда коммерческой недвижимости c арендной ставкой от '.$offer->init_value.' руб./год'.' в Москве' 
        );    
} else {
        $this->breadcrumbs=array(	
             Yii::t('menu-adm','List Realestates')=>array('index'),
             'по арендной ставке'=>array('realestates/stavkaFrom'),
             'по видам'=>array('realestates/vid'),
             'Аренда коммерческой недвижимости от арендной ставки в Москве'
        );
}
?>
...
<h1>
    <?php  echo //Yii::t('all','Коммерческая недвижимость')
                ($offer
                  ? ($property->is_ceil 
                     ? 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой от '.$offer->init_value.' руб.'.' в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' целиком по арендной ставке от '.$offer->init_value.' руб./год'.' без посредников по стоимости аренды'
                      .' от собственника Москвы.'
                     : 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой от '.$offer->init_value.' руб.'.' в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' по арендной ставке от '.$offer->init_value.' руб./год'.' в бизнес центре, парке, особняке, банке, здании, жилом доме,'
                      .' комлексе без посредников от собственника Москвы.')
                  : ($property->is_ceil 
                     ? 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' от арендной ставки в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' целиком согласно арендной ставке, без посредников по стоимости аренды от собственника Москвы.' 
                     : 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' от арендной ставки в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' в бизнес центре, парке, особняке, банке, адм.здании, жилом доме, комлексе'
                      .' согласно арендной ставке, без посредников по стоимости аренды от собственника Москвы.'));?>         
</h1> 
...
<?php 
    //$model->search()->pagination->route = Yii::app()->createUrl('/realestates/stavkaFrom', array('id'=>$offer->id)); 
    $model->search()->pagination->route = Yii::app()->createUrl('/ru/realestates/stavkaFrom/'.$offer->id.'/vid/'.$property->id); 
...
<?php $this->widget('application.components.widgets.DSizerListView', array(
	...
	'itemView'=>'_view_column',
        ...
        //'ajaxUrl'=>Yii::app()->createUrl('/ru/realestates/stavkaFrom/'.$offer->id.'/vid/'.$property->id),
)); ?>    
