...
if (Yii::app()->getRequest()->getParam('price-to')) {
    $offer = FstavkaOffers::model()->find('final_value='.Yii::app()->getRequest()->getParam('price-to'));
} 
...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости с арендной ставкой до '
                     .$offer->final_value.' руб.'.' в Москве без комиссии.'
                     .' Снять нежилое помещение либо бизнес центр, банк, здание, особняк целиком по арендной ставке до '.$offer->final_value.' руб./год,'
                     .' без посредников от собственника Москвы.'
                    : '  | Аренда коммерческой недвижимости до арендной ставке в Москве без комиссии. Снять нежилое (офисное, банковское, торговое) 
                                    помещение либо бизнес центр, банк, здание, особняк целиком до арендной ставки, без посредников по стоимости аренды от собственника Москвы.');  

if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения аренды коммерческой недвижимости с арендной ставкой до '.$offer->final_value.' руб.'.' в Москве. '
                                          .$offer->seo_desc 
                                        : 'Здесь отобраны предложения аренды коммерческой недвижимости с арендной ставкой до '.$offer->final_value.' руб.'.' в Москве.'
                                         ...
                                         .' бизнес центров, банков, особняков и зданий целиком по арендной ставке до '.$offer->final_value.' руб.'
                                         .' Аренда коммерческой недвижимости с арендной ставкой до '.$offer->final_value.' руб.'
...
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости до арендной ставки нежилой недвижимости в Москве. Предложения включают аренду' 
                                        ...
                                        .' аренду бизнес центров, банков, особняков и зданий целиком до арендной ставки. При этом аренда коммерческой недвижимости'
...
if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', 
                                                ...
                                                .', аренда по ставке меньше '.$offer->final_value.' руб.' 
                                                .', аренда по ставке меньше '.$offer->init_value.' рублей' 
                                                .', арендная ставка меньше '.$offer->init_value.' руб.' 
                                                .', арендная ставка меньше '.$offer->init_value.' рублей' 
                                                ...
                                                //.', аренда в москве арендная ставка меньше '.$offer->final_value.' руб.' 
                                                //.', аренда в москве арендная ставка меньше '.$offer->final_value.' рублей' 
                                        
                                                .', снять, аренда по арендной ставке, арендная ставка до, до, руб., рублей, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц'),
...
if ($offer) {
    $this->breadcrumbs=array(	
	 ...
	 $offer ? 'Аренда коммерческой недвижимости с арендной ставкой до '.$offer->final_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости до арендной ставки',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости с арендной ставкой до '.$offer->final_value.' руб.'.' в Москве без комиссии.'
                     .' Снять здание или нежилое помещение по арендной ставке до '.$offer->final_value.' руб./год'                       
                     .' без посредников согласно стоимости аренды от собственника Москвы.'
                    : 'Аренда коммерческой недвижимости до арендной ставки в Москве без комиссии. Снять нежилое помещение либо здание Москвы целиком 
                       до арендной ставки, без посредников от собственника.');
?>       
</h1>
<?php if ($offer->anons) {  ?>    
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_stavka_to.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/stavkaTo') : Yii::app()->createUrl('/realestates/stavkaTo',array('id'=>$offer->id)),
