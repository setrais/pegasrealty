...
if (Yii::app()->getRequest()->getParam('price-from')&&Yii::app()->getRequest()->getParam('price-to')&&Yii::app()->getRequest()->getParam('valute')) {
    $offer = FstavkaOffers::model()->find('init_value='.Yii::app()->getRequest()->getParam('price-from').' AND final_value='.Yii::app()->getRequest()->getParam('price-to').' AND valute_id='.Yii::app()->getRequest()->getParam('valute'));
} 
...
$this->pageTitle=Yii::t('all','Коммерческая недвижимость')
                .($offer 
                  ? ($property->is_ceil 
                     ? ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '.$offer->init_value.' до '
                             .$offer->final_value.' руб. '.'в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой от '.$offer->init_value.' до '
                             .$offer->final_value.' руб./год целиком, без посредников по стоимости аренды от собственника Москвы.'
                     : ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '.$offer->init_value.' до '
                             .$offer->final_value.' руб. '.'в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой '.$offer->init_value.' - '
                  ...
                  : ($property->is_ceil 
                     ? ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' по арендной ставке в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' с различной арендной ставкой в год, без посредников по стоимости аренды от собственника Москвы.' 
                     : ' | Аренда '.mb_strtolower($property->namewhats,'UTF-8').' по арендной ставке в Москве без комиссии.'
                      ...
                      .' торговом центре с различной арендной ставкой в год, без посредников по стоимости аренды от собственника Москвы.'));
...
if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения по аренде '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '
                                            .$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве. '                                          
                                          .$offer->seo_desc 
                                        : 'Здесь отобраны предложения по аренде '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '
                                          .$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве.';                   
else $this->pageDescription= 'Здесь отобраны предложения по аренде '.mb_strtolower($property->namewhats,'UTF-8').' с различной арендной ставкой в Москве. ';
...
if ( !$property->seo_description && !$offer->seo_desc) {
    if ($offer) {
        $this->pageDescription = ($property->is_ceil 
                                  ? 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '
                                    .$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве. '
                                   .'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' целиком с арендной ставкой от '.$offer->init_value.' до '.$offer->final_value.' руб./год'
                                   .' отличается адресом, назначением, свойствами, удаленностью от метро, классом, стоимостью, валютой.'
                                  : 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой в год от '
                                    .$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                   .' в бизнес центре, парке, жилом комплексе, доме, особняке, здании, медцентре, банке Москвы.'
                                   .' Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой от '
                                    .$offer->init_value.' до '.$offer->final_value.' руб./год'.' отличается объектом размещения, адресом, назначением, свойствами,'
                                    .' удаленностью от метро, классом, стоимостью, валютой.');
    }else{
        $this->pageDescription = ($property->is_ceil 
                                  ? 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' по арендной ставке '
                                   .' в Москве. Аренда '.mb_strtolower($property->namewhats,'UTF-8').' целиком с различной арендной ставки в год '
                                   .' также отличается адресом, назначением, свойствами, удаленностью от метро, классом, стоимостью, валютой.'
                                  : 'Предложения включают аренду '.mb_strtolower($property->namewhats,'UTF-8').' по арендной ставке '
                                   .' в бизнес центре, парке, жилом комплексе, доме, особняке, здании, медцентре, банке Москвы.'
                                   .' Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с различной арендной ставкой в год отличается объектом размещения, адресом, назначением,'
...
if ($offer) $this->pageKeywords=trim($offer->seo_keywords)<>'' 
                                ? array_merge( explode(',', //'аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб.'
                                                         ...
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' рублей'
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' до '.$offer->final_value.' рублей'
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' рублей' 
                                        
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой больше '.$offer->init_value.' руб.' 
                                                         //.', аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой больше '.$offer->init_value.' рублей' 
                                                         ...
                                                         ./*', аренда '.mb_strtolower($property->namewhats,'UTF-8').' в москве */', арендная ставка '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                         ...
                                                         ./*', аренда '.mb_strtolower($property->namewhats,'UTF-8').' в москве */', арендная ставка '.$offer->init_value.'-'.$offer->final_value.' рублей' 
                                                         //./*', аренда '.mb_strtolower($property->namewhats,'UTF-8').' в москве */', арендная ставка больше '.$offer->init_value.' рублей' 
                                                         //./*', аренда '.mb_strtolower($property->namewhats,'UTF-8').' в москве */', арендной ставке больше '.$offer->init_value.' рублей'
                                        
                                                         .', аренда'.' '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         .', аренда'.' '.mb_strtolower($property->namewhats,'UTF-8').' арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         //.', аренда'.' '.mb_strtolower($property->namewhats,'UTF-8').' в москве с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         //.', аренда'.' '.mb_strtolower($property->namewhats,'UTF-8').' москвы с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'
                                                         
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб. '
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' в москве с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб. '
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' москвы с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб. '                                                                                                 
                                                         //+.', аренда'.' '.mb_strtolower($property->namewhat,'UTF-8').' москва с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб. '                                                          
                                                         ...
                                                         .($property->title 
                                                                       ? //', аренда '.mb_strtolower($property->title,'UTF-8').' от '.$offer->init_value.' руб.'
                                                                        ...
                                                                        //.', аренда '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        //.', аренда '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' рублей'

                                                                        //.', аренда '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой больше '.$offer->init_value.' руб.'
                                                                        //.', аренда '.mb_strtolower($property->title,'UTF-8').' с арендной ставкой больше '.$offer->init_value.' рублей'

                                                                        //+', аренда '.mb_strtolower($property->title,'UTF-8').' в москве от '.$offer->init_value.' руб.'
                                                                        //+.', аренда '.mb_strtolower($property->title,'UTF-8').' в москве с арендной ставкой от '.$offer->init_value.' руб.'
                                                                        //+.', аренда '.mb_strtolower($property->title,'UTF-8').' москвы от '.$offer->init_value.' руб.'
                                                                        //+.', аренда '.mb_strtolower($property->title,'UTF-8').' москвы с арендной ставкой от '.$offer->init_value.' руб.'
                                                                        //.', аренда '.mb_strtolower($property->title,'UTF-8').' москва от '.$offer->init_value.' руб.'
                                                                        //.', аренда '.mb_strtolower($property->title,'UTF-8').' москва с арендной ставкой от '.$offer->init_value.' руб.'
                                                                        /*' аренда '.mb_strtolower($property->title,'UTF-8').' в москве '.*/', от '.$offer->init_value.' руб.'
                                                                        ./*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', до '.$offer->final_value.' руб.'
                                                                        ./*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        ./*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' рублей'
                                                                        //./*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', с арендной ставкой больше '.$offer->init_value.' рублей'
                                                                        //./*', аренда '.mb_strtolower($property->title,'UTF-8').' в москве */', с арендной ставкой больше '.$offer->init_value.' рублей'
                                                          ...
                                                          .($property->abbr 
                                                                        ...
                                                                        //.', аренда '.mb_strtolower($property->abbr,'UTF-8').' с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        //.', аренда '.mb_strtolower($property->abbr,'UTF-8').' с арендной ставкой '.$offer->init_value.'-'.$offer->final_value.' рублей'

                                                                        //.', аренда '.mb_strtolower($property->abbr,'UTF-8').' с арендной ставкой больше '.$offer->init_value.' руб.'
                                                                        //.', аренда '.mb_strtolower($property->abbr,'UTF-8').' с арендной ставкой больше '.$offer->init_value.' рублей'
                                                                        ...
                                                                        ./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', по арендной ставке '.$offer->init_value.'-'.$offer->final_value.' руб.'
                                                                        ...
                                                                        ./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', по арендной ставке '.$offer->init_value.'-'.$offer->final_value.' рублей'
                                                                        //./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', по арендной ставке больше '.$offer->init_value.' руб.'
                                                                        //./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', по арендной ставке больше '.$offer->init_value.' рублей'
                                                            ...
                                                            .', снять, арендная ставка, от, между, ставка, больше, до, руб., рублей, каталог, недвижимость, аренда, москва, в москве, москвы, класса, коммерческой недвижимости, округ, район, метро, удаленность, вид, свойства, площадь, м2, планировка, парковка, стоимость'),
                                ...
                                : explode(',', //'аренда '.mb_strtolower($property->namewhats,'UTF-8').' от '.$offer->init_value.' руб.'
                                                         ...
                                                         .($property->title 
                                                          ...
                                                          .($property->abbr 
                                                                        ...
                                                                        ./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', от '.$offer->init_value.' рублей'
                                                                        ./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', до '.$offer->final_value.' рублей'
                                                                        ./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', по арендной ставке '.$offer->init_value.'-'.$offer->final_value.' кв.м'
                                                                        //./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', по арендной ставке больше '.$offer->init_value.' руб.'
                                                                        //./*', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве */', по арендной ставке больше '.$offer->init_value.' рублей'
                                                                        //+.', аренда '.mb_strtolower($property->abbr,'UTF-8').' в москве '
                                                                        //+.', аренда '.mb_strtolower($property->abbr,'UTF-8').' москвы '
                                                                        ...
                                                                        .', '.mb_strtolower($property->abbr,'UTF-8') : '')  
                                                            .', снять, арендная ставка, от, между, ставка, больше, до, руб., рублей, каталог, недвижимость, аренда, москва, в москве, москвы, класса, коммерческой недвижимости, округ, район, метро, удаленность, вид, свойства, площадь, м2, планировка, парковка, стоимость');                   
else $this->pageKeywords=explode(',', 'снять, аренда в москве, аренда москвы, аренда по ставке, ставка, от, между, ставке, больше, до, руб., рублей, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, класса, коммерческой недвижимости, округ, район, улица, метро, удаленность, вид, свойства, площадь, планировка, парковка, стоимость в месяц, налогооблажение');    
...
if ($offer&&$property->namewhats) {
        ...
        $this->breadcrumbs=array(	
             ...
             'по арендной ставке'=>array('realestates/stavka'),
             'арендная ставка '.$offer->init_value.' - '.$offer->final_value.' руб./год'=>Yii::app()->createUrl('realestates/stavka',array('id'=>$offer->id)),
             'по видам'=>array('realestates/vid'),
              mb_strtolower($property->nameov,'UTF-8')=>Yii::app()->createUrl('realestates/vid',array('id'=>$property->id)),
             'Аренда '.mb_strtolower($property->namewhats,'UTF-8')." с арендной ставкой от ".$offer->init_value.' до '.$offer->final_value.' руб./год'.' в Москве' 
        );
        ...
        $this->breadcrumbs=array(	
             ...
             'по видам'=>array('realestates/vid'),
              mb_strtolower($property->nameov,'UTF-8')=>Yii::app()->createUrl('realestates/vid',array('id'=>$property->id)),
             'Аренда '.mb_strtolower($property->namewhats,'UTF-8')." c арендной ставкой от ".$offer->init_value.' до '.$offer->final_value.' руб./год'.' в Москве'
        );
} else if ($offer && !$property->namewhats) {
        ...
        $this->breadcrumbs=array(	
             ...
             'арендная ставка '.$offer->init_value.' - '.$offer->final_value.' руб./год'=>Yii::app()->createUrl('realestates/stavka',array('id'=>$offer->id)),
             'по видам'=>array('realestates/vid'),
             'Аренда коммерческой недвижимости c арендной ставкой от '.$offer->init_value.' до '.$offer->final_value.' руб./год'.' в Москве' 
        );    
} else {
        $this->breadcrumbs=array(	
             Yii::t('menu-adm','List Realestates')=>array('index'),
             'по арендной ставке'=>array('realestates/stavka'),
             'по видам'=>array('realestates/vid'),
             'Аренда коммерческой недвижимости различной арендной ставкой в Москве'
        );
}
...
<h1>
    <?php  echo //Yii::t('all','Коммерческая недвижимость')
                ($offer
                  ? ($property->is_ceil 
                     ? 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой от '.$offer->init_value.' руб. до '.$offer->final_value.' руб.'.' в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' целиком по арендной ставке от '.$offer->init_value.' до '.$offer->final_value.' руб./год'.' без посредников по стоимости аренды'
                      .' от собственника Москвы.'
                     : 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' с арендной ставкой от '.$offer->init_value.' до '.$offer->final_value.' руб.'.' в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' по арендной ставке '.$offer->init_value.' - '.$offer->final_value.' руб./год'.' в бизнес центре, парке, особняке, банке, здании, жилом доме,'
                      .' комлексе без посредников от собственника Москвы.')
                  : ($property->is_ceil 
                     ? 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' по арендной ставке в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' целиком с различной арендной ставкой, без посредников по стоимости аренды от собственника Москвы.' 
                     : 'Аренда '.mb_strtolower($property->namewhats,'UTF-8').' по арендной ставке в Москве без комиссии.'
                      .' Снять '.mb_strtolower($property->title,'UTF-8').' в бизнес центре, парке, особняке, банке, адм.здании, жилом доме, комлексе'
                      .' с различной арендной ставкой, без посредников по стоимости аренды от собственника Москвы.'));?>            
</h1> 
...
<? } ?>        
<?php 
    //$model->search()->pagination->route = Yii::app()->createUrl('/realestates/stavka', array('id'=>$offer->id)); 
    $model->search()->pagination->route = Yii::app()->createUrl('/ru/realestates/stavka/'.$offer->id.'/vid/'.$property->id); 
...
<?php $this->widget('application.components.widgets.DSizerListView', array(
	...
	'itemView'=>'_view_column',
        ...
        //'ajaxUrl'=>Yii::app()->createUrl('/ru/realestates/stavka/'.$offer->id.'/vid/'.$property->id),
)); ?>    
