...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости площадью до '
                     .$offer->final_value.' м2'.' в Москве без комиссии.'
                     .' Снять нежилую недвижимость до '.$offer->final_value.' м2,'
                     .' без посредников по стоимости аренды от собственника в разных частях г.Москвы.'
                    : '  | Аренда коммерческой недвижимости по площади в Москве без комиссии. Снять нежилую недвижимость различной площади, без посредников'
                     .' по стоимости аренды от собственника в разных частях г.Москвы.');                  

if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
                                        ? 'Здесь отобраны предложения аренды коммерческой недвижимости площадью до '.$offer->final_value.' м2'.' в Москве. '
                                          .$offer->seo_desc 
                                        : 'Здесь отобраны предложения аренды коммерческой недвижимости площадью до '.$offer->final_value.' м2'.' в Москве. '
                                         .'Предложения включают аренду нежилой недвижимости в разных частях г.Москвы площадью до '.$offer->final_value.' м2'
                                         .'. Аренда нежилой недвижимости площадью до '.$offer->final_value.' м2'
...
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости по площади в разных частях Москвы. Предложения включают аренду ' 
                                        .'нежилой недвижимости в Москве отличающихся между собой сдаваемой площадью. Аренда коммерческой недвижимости '
...
if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', ' аренда до '.$offer->final_value.' м2'
                                                .', аренда до '.$offer->final_value.' кв.м'
                                        
                                                .', аренда площадью до '.$offer->final_value.' м2' 
                                                .', аренда площадью до '.$offer->final_value.' кв.м' 
                                                ...
                                                .', аренда в москве площадью до '.$offer->final_value.' м2' 
                                                .', аренда в москве площадью до '.$offer->final_value.' кв.м'                                         
                                                .', аренда площади, площадь, площадь до, до, кв.м, квадратный метр, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц, снять, нежилая, часть'),
                                ...
                                : explode(',',   ' аренда до '.$offer->final_value.' м2'
                                                .', аренда до '.$offer->final_value.' кв.м'
...
if ($offer) {
    $this->breadcrumbs=array(	
         ...
         'по площади в части'=>array('realestates/areaTo'),
	 $offer ? "Аренда коммерческой недвижимости площадью до ".$offer->final_value." м2 в разных частях Москвы" 
                : 'Аренда коммерческой недвижимости по площади в разной части Москвы',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
	 $offer ? "Аренда коммерческой недвижимости площадью до ".$offer->final_value." м2 в разных частаях Москвы" 
                : 'Аренда коммерческой недвижимости по площади в разных частях Москвы ',
    );
}
?>
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости площадью до '.$offer->final_value.' м2'.' в Москве без комиссии.'
                     .' Снять нежилую недвижимость площадью до '.$offer->final_value.' м2'                       
                     .' без посредников по стоимости аренды от собственника в разных частях Москвы.'
                    : 'Аренда коммерческой недвижимости по площади в Москве без комиссии. Снять нежилую недвижимость'
                     .' различной площади, без посредников по стоимости аренды от собственника в разных частях г.Москвы.');
?>        
</h1>
<?php if ($offer->anons) {  ?>    
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_area_to.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/areaTo') : Yii::app()->createUrl('/realestates/areaTo',array('id'=>$offer->id)),       
