...
if (Yii::app()->getRequest()->getParam('price-from')) {
    $offer = FstavkaOffers::model()->find('init_value='.Yii::app()->getRequest()->getParam('price-from'));
} 
...
$this->pageTitle= Yii::t('all','Коммерческая недвижимость')
                    .( $offer 
                    ? ' | Аренда коммерческой недвижимости с арендной ставкой от '.$offer->init_value.' руб.'.' в Москве без комиссии.'
                     .' Снять нежилое помещение либо бизнес центр, банк, здание, особняк целиком по арендной ставке от '
                     .$offer->init_value.' руб./год,'
                     .' без посредников от собственника Москвы.'
                    : '  | Аренда коммерческой недвижимости от арендной ставки в Москве без комиссии. Снять нежилое (офисное, банковское, торговое) 
                                    помещение либо бизнес центр, банк, здание, особняк целиком согласно арендной ставке, без посредников по стоимости аренды от собственника Москвы.');

if ($offer) $this->pageDescription=$offer->seo_desc 
                             ? $offer->seo_desc 
                             : Yii::t('all','Здесь отобраны предложения по аренде коммерческой недвижимости с арендной ставкой от '.$offer->init_value.' руб.');                   
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения по аренде коммерческой недвижимости с различной арендной ставкой');                   
...
if ($offer) $this->pageDescription= trim($offer->seo_desc)<>'' 
...
else $this->pageDescription=Yii::t('all','Здесь отобраны предложения аренды коммерческой недвижимости от арендной ставки нежилой недвижимости в Москве. Предложения включают аренду' 
                                        ...
                                        .' аренду бизнес центров, банков, особняков и зданий целиком отличающихся между собой арендной ставкой. При этом арендная ставка коммерческой недвижимости'
                                        .' зависит от вида, класса, объекта размещения, адреса, назначения, свойства, удаленностью от метро,'
...
if ($offer) $this->pageKeywords=$offer->seo_keywords 
                                ? array_merge( explode(',', 
                                                ...
                                                //.', аренда в москве арендная ставка больше'.$offer->init_value.' рублей.' 
                                        
                                                .', снять, аренда по арендной ставке, арендная ставка от, от, руб., рублей, м2, каталог недвижимости, недвижимость, аренда, москва, в москве, москвы, район, метро, от метро, планировка, парковка, вид, класс, налоговая, налогообложение, отдельный вход, кк, свойства, арендная ставка, стоимость в месяц'),
...
if ($offer) {
    $this->breadcrumbs=array(	
	 ...
	 $offer ? "Аренда коммерческой недвижимости с арендной ставкой от ".$offer->init_value." руб. в Москве" 
                : 'Аренда коммерческой недвижимости от арендной ставки',
    );
} else {
    $this->breadcrumbs=array(	
         Yii::t('menu-adm','List Realestates')=>array('index'),
...
<?php echo //Yii::t('all','Коммерческая недвижимость').' | '.
           ($offer
                    ? 'Аренда коммерческой недвижимости с арендной ставкой от '.$offer->init_value.' руб.'.' в Москве без комиссии.'
                     .' Снять здание или нежилое помещение по арендной ставке от '.$offer->init_value.' руб./год'                       
                     .' без посредников согласно стоимости аренды от собственника Москвы.'
                    : 'Аренда коммерческой недвижимости от арендной ставки в Москве без комиссии. Снять нежилое помещение либо здание Москвы целиком 
                       согласно арендной ставке, без посредников от собственника.');
?> 
</h1>
<?php if ($offer->anons) {  ?>    
...
<?php
    // Переменная $extraRowExpression    
    include __DIR__ . '/include/_var_extrowexp_stavka_from.php';
?>
...
<?php $this->widget('ext.groupgridview.GroupGridView'/*zii.widgets.grid.CGridView'*/, array(
	...
	'dataProvider'=>$model->search($short ? 8 : 10),
        ...
        'ajaxUrl'=>$property->is_all ? Yii::app()->createUrl('/realestates/stavkaFrom') : Yii::app()->createUrl('/realestates/stavkaFrom',array('id'=>$offer->id)),
