...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php// echo $form->labelEx($model,'seo_title',array('label'=>'SEO заголовок')); ?>
                <?php $optTitle=CHtml::ajaxLink('',Yii::app()->createUrl('areas/genTitle'), array(
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#areas-form").serialize()',    
                                                                'beforeSend'=>'function(){                                                            
                                                               ...
                                                               'complete' => 'function(){
                                                                ...
                                                                'success' => "js:function(data){                                                                     
                                                                    $('#Areas_seo_title').val(data.content); 
                                ...
                                array('size'=>87,'maxlength'=>255, 'style'=>'width:540px;',
                                      'onfocus'=>/*"var seo_title=$('#Realestates_seo_title').val();
                                        if (seo_title.length()===0) { ".*/CHtml::ajax( array(
                                                                'url'=>Yii::app()->createUrl('Areas/genTitle'),
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#areas-form").serialize()',    
                                                                'beforeSend'=>'function(){   
                                                                    var seo_title=$("#Areas_seo_title").val();
        ...
        <div class="row">
                 <?php $optDesc=CHtml::ajaxLink('',Yii::app()->createUrl('Areas/genDescription'), array(
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#areas-form").serialize()',    
                                                                'beforeSend'=>'function(){                                                            
                                                               ...
                                                               'complete' => 'function(){
                                                                ...
                                                                //'update'=>'#loadCity',     
                                                                'success' => "js:function(data){                                                                     
                                                                    $('#Areas_seo_desc').val(data.content); 
                                                                    createTextAreaWidget('Areas_seo_desc', 175, 250, false)
                                                                 }"
                                                       ),
		...
		<?php echo $form->textArea($model,'seo_desc',
                                           array('rows'=>6, 'cols'=>65, /*'maxlength'=>450,*/ 'OnKeyUp'=>'createStat(this, 175, 250, false);', 'OnChange'=>'createStat(this, 175, 250, false);', 'style'=>"width:540px;", 
                                                 ...
                                                 if (seo_desc.length()===0) { ".*/CHtml::ajax( array(
                                                                'url'=>Yii::app()->createUrl('Areas/genDescription'),
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#areas-form").serialize()',    
                                                                'beforeSend'=>'function(){   
                                                                    var seo_desc=$("#Areas_seo_desc").val();
            ...
            <script>            
                createTextAreaWidget('Areas_seo_desc', 200, 450, false);
		...
		<?php// echo $form->labelEx($model,'seo_keywords',array('label'=>'SEO ключевые слова')); ?>
                <?php $optKeywords = CHtml::ajaxLink('',Yii::app()->createUrl('areas/genKeywords'), array(
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#areas-form").serialize()',    
                                                                'beforeSend'=>'function(){                                                            
                                                               ...
                                                               'complete' => 'function(){
                                                                ...
                                                                //'update'=>'#loadCity',     
                                                                'success' => "js:function(data){                                                                     
                                                                    $('#Areas_seo_keywords').val(data.content); 
                           ...
                           array('rows'=>6, 'cols'=>65, /*'maxlength'=>175,*/ 'OnKeyUp'=>'createStat(this, 175, 300, false);', 'OnChange'=>'createStat(this, 175, 300, false);', 'style'=>"width:540px;",
                                 'onfocus'=>/*"var title=$('#Iblocks_title').val();
                                        if (title.length()===0) { ".*/CHtml::ajax( array(
                                                                'url'=>Yii::app()->createUrl('Areas/genKeywords'),
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#areas-form").serialize()',    
                                                                'beforeSend'=>'function(){   
                                                                    var seo_keywords=$("#Areas_seo_keywords").val();
                                                               ...
                                                               'complete' => 'function(){                                                                       
                                                                ...
                                                                'success' => "js:function(data){                                                                     
                                                                    $('#Areas_seo_keywords').val(data.content); 
                                                                    createTextAreaWidget('Areas_seo_keywords', 175, 300, false);
                                                                 }"
                                                       )/*."} else { return false; }"*/
                                    ))); ?>		
	...
	<div class="row">
		<?php echo $form->labelEx($model,'weigth'); ?>
		<?php echo $form->textField($model,'weigth'); ?>
		<?php echo $form->error($model,'weigth'); ?>
	</div>
