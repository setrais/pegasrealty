...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <?php /*<div class="row">
                    ...
                    <?php echo $form->textField($model,'sort_main', array('style'=>'width:34px;', 'maxlength'=>'4')); ?>
		...
		<?php echo $form->textArea($model,'anons',array('rows'=>6, 'cols'=>65,'style'=>"width:540px;", 'OnKeyUp'=>'createStat(this, 200, 450);', 'OnChange'=>'createStat(this, 200, 450);')); ?>		
                ...
                <script>
                    createTextAreaWidget('RealestateClasses_anons', 200, 450);
                </script>
	</div>
	...
	<div class="row">
		...
		<?php// echo $form->labelEx($model,'seo_title',array('label'=>'SEO заголовок')); ?>
                <?php $optTitle=CHtml::ajaxLink('',Yii::app()->createUrl('realestateClasses/genTitle'), array(
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#realestate-classes-form").serialize()',    
                                                                'beforeSend'=>'function(){                                                            
                                                               ...
                                                               'complete' => 'function(){
                                                                ...
                                                                'success' => "js:function(data){                                                                     
                                                                    $('#RealestateClasses_seo_title').val(data.content); 
                                                                    createTextAreaWidget('RealestateClasses_seo_title', 175, 250, false)
                                                                 }"
                                                       ),
                                ...
                                array('size'=>87,'maxlength'=>255, 'style'=>'width:540px;',
                                      'onfocus'=>/*"var seo_title=$('#Realestates_seo_title').val();
                                        if (seo_title.length()===0) { ".*/CHtml::ajax( array(
                                                                'url'=>Yii::app()->createUrl('realestateClasses/genTitle'),
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#realestate-classes-form").serialize()',    
                                                                'beforeSend'=>'function(){   
                                                                    var seo_title=$("#RealestateClasses_seo_title").val();
		...
		<?php echo $form->error($model,'seo_title'); ?>      
                <script>
                    $("#RealestateClasses_seo_title").charCount({
                        allowed: 80,
                        warning: 75,
        ...
        <div class="row">
                 <?php $optDesc=CHtml::ajaxLink('',Yii::app()->createUrl('realestateClasses/genDescription'), array(
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#realestate-classes-form").serialize()',    
                                                                'beforeSend'=>'function(){                                                            
                                                               ...
                                                               'complete' => 'function(){
                                                                ...
                                                                //'update'=>'#loadCity',     
                                                                'success' => "js:function(data){                                                                     
                                                                    $('#RealestateClasses_seo_desc').val(data.content); 
                                                                    createTextAreaWidget('RealestateClasses_seo_desc', 175, 250, false)
                                                                 }"
                                                       ),
		...
		<?php echo $form->textArea($model,'seo_desc',
                                           array('rows'=>6, 'cols'=>65, /*'maxlength'=>450,*/ 'OnKeyUp'=>'createStat(this, 175, 250, false);', 'OnChange'=>'createStat(this, 175, 250, false);', 'style'=>"width:540px;", 
                                                 ...
                                                 if (seo_desc.length()===0) { ".*/CHtml::ajax( array(
                                                                'url'=>Yii::app()->createUrl('realestateClasses/genDescription'),
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#realestate-classes-form").serialize()',    
                                                                'beforeSend'=>'function(){   
                                                                    var seo_desc=$("#RealestateClasses_seo_desc").val();
            ...
            <script>            
                createTextAreaWidget('RealestateClasses_seo_desc', 200, 450, false);
		...
		<?php// echo $form->labelEx($model,'seo_keywords',array('label'=>'SEO ключевые слова')); ?>
                <?php $optKeywords = CHtml::ajaxLink('',Yii::app()->createUrl('realestateClasses/genKeywords'), array(
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#realestate-classes-form").serialize()',    
                                                                'beforeSend'=>'function(){                                                            
                                                               ...
                                                               'complete' => 'function(){
                                                                ...
                                                                //'update'=>'#loadCity',     
                                                                'success' => "js:function(data){                                                                     
                                                                    $('#RealestateClasses_seo_keywords').val(data.content); 
                                                                    createTextAreaWidget('RealestateClasses_seo_keywords', 175, 300, false)
                                                                 }"
                                                       ),
                           ...
                           array('rows'=>6, 'cols'=>65, /*'maxlength'=>175,*/ 'OnKeyUp'=>'createStat(this, 175, 300, false);', 'OnChange'=>'createStat(this, 175, 300, false);', 'style'=>"width:540px;",
                                 'onfocus'=>/*"var title=$('#Iblocks_title').val();
                                        if (title.length()===0) { ".*/CHtml::ajax( array(
                                                                'url'=>Yii::app()->createUrl('realestateClasses/genKeywords'),
                                                                'type'=>'POST', 
                                                                'dataType'=>'json',    
                                                                'data'=>'js:$("#realestate-classes-form").serialize()',    
                                                                'beforeSend'=>'function(){   
                                                                    var seo_keywords=$("#RealestateClasses_seo_keywords").val();
