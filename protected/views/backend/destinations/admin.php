...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('destinations-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1><?php echo Yii::t('adm-menu','Manage Destinations'); ?></h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
            ...
            array( 'name'=>'abbr',
                   'headerHtmlOptions'=>array('width'=>'60'),
                   'htmlOptions'=>array('style'=>'width:60px;text-align:left;vertical-align: middle;'),
                   'visible'=>true
            ),             
