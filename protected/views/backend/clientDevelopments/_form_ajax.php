...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'client-developments-form',
        'htmlOptions'=>array('class'=>'client-developments'), 
	...
	<div class="row">
		<?php echo $form->labelEx($model,'development_id'); ?>
                <?php echo $form->dropDownList($model,'development_id',                           
                           CHtml::listData( Developments::model()->findAll("(ACT IS NULL OR ACT=1) AND (DEL IS NULL OR DEL=0)",
                             array("order"=>"sort")), 'id', 'desc'), array('prompt'=>Yii::t('all','Select')."...")); ?>                                                                     
                <?php echo $form->error($model,'development_id'); ?>
	</div>
	...
	<div class="row buttons">
            <?php echo CHtml::ajaxSubmitButton($model->isNewRecord ? Yii::t('form','Create') : Yii::t('form','Save'),
                    Yii::app()->controller->createUrl("/clientDevelopments/"
                            .( $model->isNewRecord ? "ajaxcreate" : "ajaxupdate"), 
                            array("id"=>( $model->isNewRecord ? $model->client_id : $model->id )) ),
