...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		'class'=>'CButtonColumn',                
            ...
            array(
                'class'=>'CButtonColumn',
                'template'=> ( Yii::app()->user->checkAccess('superadmin') ?  '{view} {update} {copy} {delete}' : (Yii::app()->user->checkAccess('editor') ? '{view} {update}' : '{view} {update} {copy}') ) ,
                'buttons'=>array( 'copy'=>
                                  array( 'label'=>'Copy',
            ...
            array(  'name'=>'act',
                  ...
                  'visible'=>Yii::app()->user->checkAccess('editor') ? false : true,
                ),  
            /*array('name'=>'del',
                  'header'=>Yii::t('all','X'),
                  'type'=>'text',
           ...
           array( 'name'=>'realestate_vid_id',
                  ...
                  'filter'=>CHtml::listData(RealestateVids::model()->findAll(array("select"=>"t.id,t.abbr",
           ...
           array( 'name'=>'realestate_class_id',
                  ...
                  'filter'=>CHtml::listData(RealestateClasses::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'),
           ...
           array( 'name'=>'district_id',
                  ...
                  'filter'=>CHtml::listData(Districts::model()->findAll(array("select"=>"t.id,t.title",
                                                                              "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
           ...
           array( 'name'=>'areas_id',
                  ...
                  'htmlOptions'=>array('style'=>'width:40px;'/*60px*/),
                  'filter'=>CHtml::listData(Areas::model()->findAll(array("select"=>"t.id,t.title",
                                                                          "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                          "order"=>"t.sort")), 'id', 'title'),
                  'headerHtmlOptions'=>array('width'=>'40'/*60px*/),
                  'visible'=>false,
           ...
           array( 'name'=>'metro_id',
                  ...
                  'filter'=>CHtml::listData(Metros::model()->findAll(array("select"=>"t.id,t.title")), 'id', 'title'),
          ...
          array(  'name'=>'date_rang',
                  'header'=>Yii::t('all','ДатаВремя звонка'),//Yii::t('all','Date of call'),
                  'type'=>'text',
                  'filter' => $this->widget ('ext.CJuiDateTimePicker.CJuiDateTimePicker',
                array(
			...
			'buttonImageOnly'=> true,
                ...
                /*$this->widget('zii.widgets.jui.CJuiDatePicker', 
                  ...
                  'value'=>'date("d.m.Y H:i",strtotime($data->date_rang))',
          ...
          array(  'name'=>'planning_id',
                  ...
                  'filter'=>CHtml::listData(Plannings::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'),              
          ...
          array(  'name'=>'valute_id',
                  ...
                  'type'=>'text',
                  'filter'=>CHtml::listData(Valutes::model()->findAll(array("select"=>"t.id,t.title",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'title'),              
          ...
          array(  'name'=>'tax_id',
                  ...
                  'type'=>'text',
                  'filter'=>CHtml::listData(Taxs::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'),              
                  'value'=>'$data->tax->abbr',                     
          ...
          array(  'name'=>'parking_id',
                  ...
                  'filter'=>CHtml::listData(Parkings::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'), 
          ...
          array(  'name'=>'representative_id',
                  ...
                  'type'=>'html',
                  'filter'=>CHtml::listData(Representatives::model()->findAll(array("select"=>"t.id,t.name")), 'id', 'name'), 
          ...
          array(  'name'=>'commission_id',
                  ...
                  'type'=>'text',
                  'filter'=>CHtml::listData(Commissions::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'), 
         ...
         array(   'name'=>'is_separate_entrance',
          ...
          array(  'name'=>'number_tax',
                  'header'=>Yii::t('all','№ tax'),
                  'type'=>'text',                  
                  'filter'=>CHtml::listData(TaxReference::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'),
          ...
          array(  'name'=>'realestate_type_id',
                  ...
                  'type'=>'text',
                  'filter'=>CHtml::listData(RealestateTypes::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'), 
         ...
         array(   'name'=>'operation_id',
                  ...
                  'type'=>'text',
                  'filter'=>CHtml::listData(Operations::model()->findAll(array("select"=>"t.id,t.abbr",
                                                                                      "condition"=>"(t.act IS NULL OR t.act=1) AND (t.del IS NULL OR t.del=0)",
                                                                                      "order"=>"t.sort")), 'id', 'abbr'), 
          ...
          array(  'name'=>'street_id', 
                  'type'=>'text',                  
                  'headerHtmlOptions'=>array('width'=>'100'),
                  'filter'=>CHtml::listData(Streets::model()->findAll(array("select"=>"id,title"/*concat(t.SOCR,'.',t.name) as 'name'"*/)), 'id', 'title'),               
                  'value'=>'$data->street->title;',//SOCR.".".$data->street->name;',                     
                  'htmlOptions'=>array('style'=>'width:100px;'),
                  'visible'=>false,
                ),              
