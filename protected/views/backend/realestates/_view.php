<div class="view"> 
  <div>
    <div class="left-col" >
       ...
       foreach ($data->realestateFotos as $key=>$realestateFoto) $realestateFotos[] = $realestateFoto->file_id; 
                ...
                echo CHtml::link(CHtml::image( $picFoto, '', 
                                   array('title'=>$foto->name)),                                                       
                                     ...
                                     array('class'=>'fancySladeShow',
                                           'rel'=>"realestateFotos".$realestateFoto->id,
                                           'title'=>$foto->name));                           
            ?>                       
            </div>
          </div>
   <?php   } ?>
          <script>
                $(document).ready(function() {
                   //$(".fancySladeShow").attr("rel","realestateFotos<?=$realestateFoto->id;?>"); 
                   $(".fancySladeShow[rel=realestateFotos<?=$realestateFoto->id;?>]").fancybox({
   ...
   <?php $realestatePresentations=array();
      foreach ($data->realestatePresentations as $key=>$realestatePresentation) $realestatePresentations[] = $realestatePresentation->file_id; 
   ...
   ?>               
    ...
    <div class="right-col" >
        ...
        <div>
            ...
            <br />                       
            <? if ( $data->street_id || $data->newstreet) : ?>            
            <b><?php echo CHtml::encode($data->getAttributeLabel('street_id')); ?>:</b>
            <span class="ed"><?php echo CHtml::encode($data->street_id ? $data->street->SOCR.'.'.$data->street->name : $data->newstreet); ?></span>
            <br />            
            <? endif; ?>
	...
	<br />*/?>
        ...
        <b>
          <?php// echo CHtml::encode($data->getAttributeLabel('realestate_vid_id')); ?>
