...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'orders-form',
        'htmlOptions'=>array('class'=>'orders'), 
	...
	<div class="row buttons">
        ...
        <?php echo CHtml::ajaxSubmitButton($model->isNewRecord ? Yii::t('form','Create') : Yii::t('form','Save'),
                    Yii::app()->controller->createUrl("orders/".( $model->isNewRecord ? "ajaxcreate" : "ajaxupdate"), array("id"=>($model->isNewRecord ? $cid : $model->id)) ),
                    array('success'=>"js:function(data){
                                      $('#editbox-order').dialog('close');                                                                                                          
