...
function() {
    ...
    $.get(url, function(data) {
        $('#wind-histories').html(data);        
        $('#wind-histories.popup').dialog({
                            title:'Просмотр истории заявки',
                            modal: true,
                            width: '960',
                            close: function(event, ui) { 
                                 $('#wind-histories').empty();
                                 $('#wind-histories').dialog('destroy');
                               }
                            });                                                        
    });
    return false;
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
	      ...
	      array( 'class'=>'CButtonColumn',
                     ...
                     'buttons'=>array( 'view'=>
                                       array( 'label'=>'View',
                                              'url'=>'Yii::app()->controller->createUrl("/orderHistories/ajaxview",array("id"=>$data->primaryKey))',
                                              'click'=>$js_preview,
                                              'visible'=>'true',    
                                       ),
                                       'send'=>
                                       array( 'label'=>'delete',
                                              'url'=>'Yii::app()->controller->createUrl("/orderHistories/delete",array("id"=>$data->primaryKey))',
                                              'visible'=>'true',    
                                       ),                                                   
                     ),                             
	      ),
...
<div id="wind-histories" class="popup"></div>