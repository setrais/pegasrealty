...
/**
 * This is the model class for table "client_scopes".
 *
 * The followings are the available columns in table 'client_scopes':
 * @property integer $id
 ...
 */
class ClientScopes extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ClientScopes the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'clients' => array(self::HAS_MANY, 'Clients', 'scope_id'),
		);
	}
