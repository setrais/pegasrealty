...
/**
 * This is the model class for table "space_types".
 *
 * The followings are the available columns in table 'space_types':
 * @property integer $id
 ...
 */
class SpaceTypes extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return SpaceTypes the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'spaces' => array(self::HAS_MANY, 'Spaces', 'space_type_id'),
		);
	}
