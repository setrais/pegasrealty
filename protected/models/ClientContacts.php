 ...
 *
 * The followings are the available columns in table 'client_contacts':
 * @property integer $id
 ...
 */
class ClientContacts extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ClientContacts the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('sort, act, del, clients_id', 'numerical', 'integerOnly'=>true),
			array('abbr, name', 'length', 'max'=>255),
			array('create_date, update_date, desc', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, abbr, name, sort, act, del, create_date, update_date, desc, clients_id', 'safe', 'on'=>'search'),
		);
	}
