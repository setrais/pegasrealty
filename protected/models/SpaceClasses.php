...
/**
 * This is the model class for table "space_classes".
 *
 * The followings are the available columns in table 'space_classes':
 * @property integer $id
 ...
 */
class SpaceClasses extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return SpaceClasses the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'spaces' => array(self::HAS_MANY, 'Spaces', 'space_class_id'),
		);
	}
