...
/**
 * This is the model class for table "realestate_status".
 *
 * The followings are the available columns in table 'realestate_status':
 * @property integer $id
 ...
 */
class RealestateStatus extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return RealestateStatus the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'clientRealestates' => array(self::HAS_MANY, 'ClientRealestates', 'status_id'),
		);
	}
