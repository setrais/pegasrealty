...
/**
 * This is the model class for table "site_vids".
 *
 * The followings are the available columns in table 'site_vids':
 * @property integer $id
 ...
 */
class SiteVids extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return SiteVids the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'clients' => array(self::HAS_MANY, 'Clients', 'site_vids_id'),
		);
	}
