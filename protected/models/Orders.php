 ...
 * @property OrderMetros[] $orderMetroses
 * @property Units $unit
...
class Orders extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('id', 'required'),
			array('id, createuser, updateuser, act, del, sort, operation_id, area_from, area_to, realestate_type_id, realestate_vid_id, realestate_class_id, district_id, valute_id, unit_id', 'numerical', 'integerOnly'=>true),
			array('price_from, price_to, remoteness, unit_value', 'length', 'max'=>10),
			array('createdate, updatedate, poligon', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, createdate, updatedate, createuser, updateuser, act, del, sort, operation_id, price_from, price_to, area_from, area_to, realestate_type_id, realestate_vid_id, realestate_class_id, district_id, valute_id, unit_id, remoteness, unit_value, poligon', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'clientOrders' => array(self::HAS_MANY, 'ClientOrders', 'order_id'),
                        'clientsOrders' => array(self::MANY_MANY, 'Orders','client_orders(client_id, order_id)'),                        
			'orderHistories' => array(self::HAS_MANY, 'OrderHistories', 'order_id'),
			'orderMetroses' => array(self::HAS_MANY, 'OrderMetros', 'order_id'),
