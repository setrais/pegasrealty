...
class m120201_135209_insert_country extends CDbMigration
{
	public function up()
	{
            /*$this->execute("INSERT INTO country(id, name) VALUES 
                              (1, 'Россия'),
                              (2, 'Украина'),
                              (3, 'Абхазия'),
                              (4, 'Австралия'),
	...
	{
		echo "m120201_135209_insert_country does not support migration down.\n";
		return false;
	}
