...
class JCloud extends CWidget
{
	...
	{  
        ...
        if (!isset($this->htmlOptions['class']))
                ...
                $baseUrl = Yii::app()->getAssetManager()->publish(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'assets' );
  	    ...
  	    Yii::app()->getClientScript()->registerCoreScript('jquery');
            ...
            Yii::app()->getClientScript()->registerScriptFile($baseUrl.$cloudJs);
            Yii::app()->getClientScript()->registerScript(__CLASS__.'#'.$id ,"jQuery('#$id').jQCloud($wordList);");
