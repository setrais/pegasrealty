...
class ESitemapModel extends CModel {
	...
	public $frequency = 'yearly';
        ...
        /*
	 * @var string The property that the link.	 
	 */
	public $link = array('text'=>null,'alt'=>null,'title'=>null);
	...
	{
		return array('frequency','priority','route','params','baseModel','scopeName','link');
	}
