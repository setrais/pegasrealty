...
class elRTE extends CInputWidget
{
    ...
    {            	    
		...
		//Yii::app()->minScript->generateScriptMap('elrte');               
    ...
    public function generateOptions()
    {
        ...
        $options .= "  'url' : '{$this->baseUrl}/connectors/php/connector.php?passkey={$this->passkey}', \n";
		//if(!empty($this->passkey)) $this->url .= '?passkey='.urlencode($this->passkey) ;
