...
class PlanningsController extends BackendController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Plannings']))
		{
			$model->attributes=$_POST['Plannings'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Plannings');
	...
	{
		$model=new Plannings('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Plannings']))
			$model->attributes=$_GET['Plannings'];
	...
	{
		$model=Plannings::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='plannings-form')
		{
