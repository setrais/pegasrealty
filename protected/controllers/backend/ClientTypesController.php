...
class ClientTypesController extends BackendController
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ClientTypes'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ClientTypes');
	...
	{
		$model=new ClientTypes('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ClientTypes']))
			$model->attributes=$_GET['ClientTypes'];
	...
	{
		$model=ClientTypes::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='client-types-form')
		{
