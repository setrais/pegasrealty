...
class ParkingsController extends BackendController
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Parkings'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Parkings');
	...
	{
		$model=new Parkings('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Parkings']))
			$model->attributes=$_GET['Parkings'];
	...
	{
		$model=Parkings::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='parkings-form')
		{
