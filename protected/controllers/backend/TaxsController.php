...
class TaxsController extends BackendController
{
	...
	{
		$dataProvider=new CActiveDataProvider('Taxs');
	...
	{
		$model=new Taxs('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Taxs']))
			$model->attributes=$_GET['Taxs'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='taxs-form')
		{
