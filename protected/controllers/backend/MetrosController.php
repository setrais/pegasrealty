...
class MetrosController extends BackendController
{
	/**
        ...
        public function actionGenTitle($id=null) {
            ...
            if( Yii::app()->request->isAjaxRequest ) {
                ...
                {               
                    ...
                    $data = array( "error"=>false, "mess"=>Yii::t('all','Gen field title for metro').($id ? " №".$id : ""), "content"=>$model->createTitle());
                }else{
                    $data = array( "error"=>true, "mess"=>Yii::t('all','No gen field title for metro').($id ? " №".$id : ""), "content"=>null);         
                }  
        ...
        public function actionGenDescription($id=null) {
            ...
            if( Yii::app()->request->isAjaxRequest ) {
                ...
                {               
                    ...
                    $data = array( "error"=>false, "mess"=>Yii::t('all','Gen field description for metro').($id ? " №".$id : ""), "content"=>$model->createDescription());
                }else{
                    $data = array( "error"=>true, "mess"=>Yii::t('all','No gen field description for metro').($id ? " №".$id : ""), "content"=>null);         
                }  
        ...
        public function actionGenKeywords($id=null) {
            ...
            if( Yii::app()->request->isAjaxRequest ) {
                ...
                {               
                    ...
                    $data = array( "error"=>false, "mess"=>Yii::t('all','Gen field keywords for metro').($id ? " №".$id : ""), "content"=>$model->createKeywords());
                }else{
                    $data = array( "error"=>true, "mess"=>Yii::t('all','No gen field keywords for metro').($id ? " №".$id : ""), "content"=>null);         
                }  
